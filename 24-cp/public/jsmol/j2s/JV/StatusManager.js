...
}var player = (this.audios == null ? null : this.audios.get(id));
if (player != null) {
...
if (status === "ended" && htParams.get("autoclose") !== Boolean.FALSE) this.registerAudio(htParams.get("id"), null);
}, "java.util.Map");
