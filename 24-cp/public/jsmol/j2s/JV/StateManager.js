...
Clazz.load(["java.util.Hashtable"], ["JV.Connection", "$.Scene", "$.StateManager", "$.Connections"], ["java.util.Arrays", "JU.BS", "$.Lst", "$.SB", "JM.Orientation", "JU.BSUtil", "$.Escape"], function(){
...
Clazz.instantialize(this, arguments);}, JV, "StateManager", null);
...
Clazz.defineMethod(c$, "restoreUnitCell", 
function(saveName){
...
this.saveName = null;
this.scene = null;
Clazz.instantialize(this, arguments);}, JV, "Scene", null);
Clazz.makeConstructor(c$, 
function(scene){
this.scene = scene;
}, "java.util.Map");
...
this.vwr = null;
Clazz.instantialize(this, arguments);}, JV, "Connections", null);
Clazz.makeConstructor(c$, 
function(vwr){
var modelSet = vwr.ms;
...
var b = bonds[i];
if (b != null) this.connections[i] =  new JV.Connection(b.atom1.i, b.atom2.i, b.mad, b.colix, b.order, b.getEnergy(), b.shapeVisibilityFlags);
}
}, "JV.Viewer");
Clazz.defineMethod(c$, "restore", 
function(){
...
var bonds = modelSet.bo;
for (var i = modelSet.bondCount; --i >= 0; ) if (bonds[i] != null) bonds[i].index = i;
...
Clazz.instantialize(this, arguments);}, JV, "Connection", null);
Clazz.makeConstructor(c$, 
