...
Clazz.load(null, "JU.MeshSurface", ["JU.AU", "$.P3", "J.api.Interface", "JU.BoxInfo", "$.C", "$.Geodesic", "$.TempArray"], function(){
...
this.isMerged = false;
Clazz.instantialize(this, arguments);}, JU, "MeshSurface", null);
