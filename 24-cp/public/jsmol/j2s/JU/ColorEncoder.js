...
Clazz.load(null, "JU.ColorEncoder", ["java.util.Hashtable", "JU.AU", "$.CU", "$.Lst", "$.PT", "$.Rdr", "J.c.PAL", "JU.C", "$.Escape", "$.Logger", "JV.FileManager", "$.JC"], function(){
...
this.ce = null;
Clazz.instantialize(this, arguments);}, JU, "ColorEncoder", null);
...
JU.Rdr.readAllAsString(JV.FileManager.getBufferedReaderForResource(this.vwr, JU.C, "JU/", "colorschemes/" + s), -1, false, data, 0);
} catch (e) {
...
c$.colorSchemes =  Clazz.newArray(-1, ["roygb", "bgyor", "byelement_jmol", "byelement_rasmol", "byresidue_shapely", "byresidue_amino", "rwb", "bwr", "low", "high", "bw", "wb", "friendly", "user", "resu", "inherit", "rgb", "bgr", "jmol", "rasmol", "byresidue", "byresidue_nucleic"]);
c$.rasmolScale = null;
