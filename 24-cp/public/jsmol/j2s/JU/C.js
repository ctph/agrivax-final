...
Clazz.load(["JU.Int2IntHash"], "JU.C", ["JU.AU", "$.CU", "$.PT", "$.SB", "J.c.PAL", "JU.Escape", "$.Logger"], function(){
var c$ = Clazz.declareType(JU, "C", null);
/*LV!1824 unnec constructor*/c$.getColix = Clazz.defineMethod(c$, "getColix", 
function(argb){
if (argb == 0) return 0;
...
c$.isTransparent = Clazz.defineMethod(c$, "isTransparent", 
function(colix){
return (colix & 30720) == 16384;
}, "~N");
...
c$.colixMax = 4;
c$.argbs =  Clazz.newIntArray (128, 0);
{
JU.C.argbs[3] = -74566;
