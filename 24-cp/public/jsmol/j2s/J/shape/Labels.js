...
Clazz.load(["J.shape.AtomShape", "java.util.Hashtable", "JU.P3"], "J.shape.Labels", ["JU.AU", "$.BS", "$.PT", "J.c.PAL", "JM.LabelToken", "$.Text", "JS.SV", "JU.BSUtil", "$.C", "$.Font", "JV.JC"], function(){
...
this.pickedX = 0;
this.pickedY = 0;
Clazz.instantialize(this, arguments);}, J.shape, "Labels", J.shape.AtomShape);
...
this.vwr.shm.notifyAtoms("atomslabeled",  Clazz.newArray(-1, [bs, null]));
}return;
...
if (this.mads == null) this.mads =  Clazz.newShortArray (ac, 0);
