...
Clazz.instantialize(this, arguments);}, J.shape, "AtomShape", J.shape.Shape);
...
if (this.mads == null && i0 >= 0) this.mads =  Clazz.newShortArray (ac, 0);
...
if (this.mads == null && i0 >= 0) this.mads =  Clazz.newShortArray (this.ms.ac, 0);
