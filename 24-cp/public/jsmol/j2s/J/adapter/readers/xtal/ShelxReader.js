...
while ((lineLength = this.line.length) > 0 && this.line.charAt(lineLength - 1) == '=') this.line = this.line.substring(0, lineLength - 1) + this.rd();
...
function(){
this.part = this.parseIntStr(this.tokens[1]);
...
x = this.parsePrecision(this.tokens[2]) % 10;
y = this.parsePrecision(this.tokens[3]) % 10;
z = this.parsePrecision(this.tokens[4]) % 10;
...
function(){
Clazz.superCall(this, J.adapter.readers.xtal.ShelxReader, "finalizeReaderASCR", []);
