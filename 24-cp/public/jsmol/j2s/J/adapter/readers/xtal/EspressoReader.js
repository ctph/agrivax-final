...
Clazz.load(["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xtal.EspressoReader", ["JU.PT"], function(){
var c$ = Clazz.decorateAsClass(function(){
this.cellParams = null;
this.totEnergy = null;
this.endFlag = false;
this.alat = 0;
Clazz.instantialize(this, arguments);}, J.adapter.readers.xtal, "EspressoReader", J.adapter.smarter.AtomSetCollectionReader);
...
function(){
this.alat = this.parseFloatStr(this.getTokens()[4]) * 0.5291772;
});
Clazz.defineMethod(c$, "readCellParam", 
function(andAPar){
var i0 = (andAPar ? 0 : 3);
if (this.line.contains("bohr")) this.alat = 0.5291772;
 else if (this.line.contains("angstrom")) this.alat = 1;
if (andAPar && this.line.contains("=")) this.alat = this.parseFloatStr(this.line.substring(this.line.indexOf("=") + 1)) * 0.5291772;
this.cellParams =  Clazz.newFloatArray (9, 0);
for (var n = 0, i = 0; n < 3; n++) {
var tokens = JU.PT.getTokens(this.rd());
this.cellParams[i++] = this.parseFloatStr(tokens[i0]) * this.alat;
this.cellParams[i++] = this.parseFloatStr(tokens[i0 + 1]) * this.alat;
this.cellParams[i++] = this.parseFloatStr(tokens[i0 + 2]) * this.alat;
}
}, "~B");
