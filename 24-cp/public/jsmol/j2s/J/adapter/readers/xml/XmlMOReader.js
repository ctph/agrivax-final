...
Clazz.load(["J.adapter.readers.xml.XmlCmlReader"], "J.adapter.readers.xml.XmlMOReader", ["java.util.Hashtable", "JU.AU", "$.Lst", "$.PT", "J.adapter.readers.quantum.BasisFunctionReader", "J.adapter.smarter.Resolver", "J.quantum.QS", "JU.Logger"], function(){
...
Clazz.instantialize(this, arguments);}, J.adapter.readers.xml, "XmlMOReader", J.adapter.readers.xml.XmlCmlReader);
...
this.htSlaterIDs.put(this.basisId + "_" + i,  Clazz.newIntArray(-1, [-1, J.adapter.readers.quantum.BasisFunctionReader.getQuantumShellTagID(otype), this.gaussianCount + 1, nPrimitives]));
