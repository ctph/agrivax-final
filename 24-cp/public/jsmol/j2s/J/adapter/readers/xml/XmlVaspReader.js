...
Clazz.load(["J.adapter.readers.xml.XmlReader"], "J.adapter.readers.xml.XmlVaspReader", ["JU.PT", "$.SB", "$.V3", "JU.Logger"], function(){
...
this.beta = 0;
this.gamma = 0;
Clazz.instantialize(this, arguments);}, J.adapter.readers.xml, "XmlVaspReader", J.adapter.readers.xml.XmlReader);
