...
Clazz.instantialize(this, arguments);}, J.adapter.readers.xml, "XmlReader", J.adapter.smarter.AtomSetCollectionReader);
...
}var rdr = this.previewXML(this.reader);
if (saxReader == null) {
...
(J.api.Interface.getOption("adapter.readers.xml.XmlHandler", this.vwr, "file")).parseXML(this, saxReader, rdr);
}}, "J.adapter.readers.xml.XmlReader,~O");
Clazz.defineMethod(c$, "previewXML", 
function(reader){
return reader;
