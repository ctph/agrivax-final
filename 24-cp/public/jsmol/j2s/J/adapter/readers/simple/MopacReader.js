...
Clazz.load(["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.simple.MopacReader", ["JU.BS", "$.PT", "JU.Logger"], function(){
var c$ = Clazz.decorateAsClass(function(){
this.chargesFound = false;
this.haveHeader = false;
this.mopacVersion = 0;
Clazz.instantialize(this, arguments);}, J.adapter.readers.simple, "MopacReader", J.adapter.smarter.AtomSetCollectionReader);
