...
Clazz.load(["J.adapter.readers.quantum.MopacSlaterReader", "JU.BS"], "J.adapter.readers.quantum.MoldenReader", ["java.util.Arrays", "$.Hashtable", "JU.AU", "$.Lst", "$.PT", "J.adapter.readers.quantum.BasisFunctionReader", "JU.Logger"], function(){
...
this.ptLineBuf = 0;
this.bufLen = 0;
Clazz.instantialize(this, arguments);}, J.adapter.readers.quantum, "MoldenReader", J.adapter.readers.quantum.MopacSlaterReader);
...
if (!this.haveCoefs) {
System.out.println(this.nCoef + " adding " + n + " coefficients type " + J.adapter.readers.quantum.BasisFunctionReader.getQuantumShellTag(type) + " for atom " + atomIndex);
this.nCoef += n;
