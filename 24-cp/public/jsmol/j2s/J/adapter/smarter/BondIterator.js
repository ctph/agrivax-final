...
this.bond = null;
this.bondCount = 0;
Clazz.instantialize(this, arguments);}, J.adapter.smarter, "BondIterator", J.api.JmolAdapterBondIterator);
...
Clazz.overrideMethod(c$, "getPymolRadius", 
function(){
return this.bond.pymolRadius;
});
