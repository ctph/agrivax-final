...
Clazz.load(["JS.Symmetry", "JU.P3", "$.SB"], "J.adapter.smarter.XtalSymmetry", ["java.util.Hashtable", "JU.A4", "$.BS", "$.Lst", "$.M3", "$.M4", "$.P3i", "$.PT", "$.V3", "J.adapter.smarter.Atom", "JS.SpaceGroup", "$.SymmetryOperation", "$.UnitCell", "JU.BSUtil", "$.Logger", "$.SimpleUnitCell"], function(){
...
Clazz.defineMethod(c$, "transformUVW", 
...
Clazz.defineMethod(c$, "magneticMomentsToFractional", 
function(acr, asc){
...
Clazz.defineMethod(c$, "setSpinFrameMatrices", 
function(acr){
...
abc = this.getCif2Array(strAxis,  Clazz.newFloatArray (3, 0));
}if (abc != null) {
...
Clazz.defineMethod(c$, "getCif2Array", 
