...
Clazz.load(["J.adapter.writers.XtlWriter", "J.api.JmolWriter", "JU.P3"], "J.adapter.writers.CIFWriter", ["JU.BS", "$.PT", "$.SB", "JU.BSUtil", "JV.Viewer"], function(){
...
var fractionalOffset = (uc.getFractionalOffset(true) != null);
var fset;
...
ita = uc.geCIFWriterValue("ita");
hallName = uc.geCIFWriterValue("HallSymbol");
hmName = uc.geCIFWriterValue("HermannMauguinSymbol");
...
var parts = (haveAltLoc ? this.vwr.getDataObj("property_part", bsOut, 1) : null);
...
for (var pi = 0, i = bsOut.nextSetBit(0); i >= 0; i = bsOut.nextSetBit(i + 1)) {
var a = atoms[i];
p.setT(a);
...
;//5.0.1-v7 Thu May 29 17:45:31 CDT 2025
