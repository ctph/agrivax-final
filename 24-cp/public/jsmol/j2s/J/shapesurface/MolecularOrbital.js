...
Clazz.load(["J.shapesurface.Isosurface"], "J.shapesurface.MolecularOrbital", ["java.util.Hashtable", "JU.AU", "$.Lst", "$.PT", "$.SB", "J.jvxl.data.JvxlCoder", "J.quantum.QS", "JU.Escape"], function(){
...
this.nboType = null;
Clazz.instantialize(this, arguments);}, J.shapesurface, "MolecularOrbital", J.shapesurface.Isosurface);
...
this.thisModel.put("moSelection", value);
return;
...
this.moSelection = this.thisModel.get("moSelection");
...
if (this.moSelection != null) this.setPropI("select", this.moSelection, null);
...
if (this.moSelection != null) {
s.append("try{/*16.2*/\n");
J.shape.Shape.appendCmd(s, this.myType + " select " + this.moSelection);
s.append("}catch{};\n");
...
if (this.thisModel == null) {
System.out.println("MolecularOrbital ???");
