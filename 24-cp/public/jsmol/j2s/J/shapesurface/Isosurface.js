...
this.ptXY = null;
this.keyXy = null;
Clazz.instantialize(this, arguments);}, J.shapesurface, "Isosurface", J.shape.MeshCollection, J.jvxl.api.MeshDataServer);
...
this.setProperty("property",  Clazz.newFloatArray (this.ms.ac, 0), null);
if (colix != 0) {
...
Clazz.overrideMethod(c$, "getValues", 
function(mesh){
return (mesh == null ? null : (mesh).getValidValues(null));
}, "J.shape.Mesh");
Clazz.overrideMethod(c$, "getVertices", 
function(mesh){
