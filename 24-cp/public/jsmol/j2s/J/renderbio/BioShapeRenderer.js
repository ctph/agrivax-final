...
Clazz.load(["J.render.ShapeRenderer", "JU.BS", "$.P3"], "J.renderbio.BioShapeRenderer", ["javajs.api.Interface", "J.c.STR", "JU.C", "$.Point3fi"], function(){
...
Clazz.instantialize(this, arguments);}, J.renderbio, "BioShapeRenderer", J.render.ShapeRenderer);
...
Clazz.defineMethod(c$, "checkStruts", 
function(i){
...
Clazz.defineMethod(c$, "getStrutPointIfNeeded", 
function(a){
