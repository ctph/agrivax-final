...
this.bsTemp = null;
this.norml = null;
Clazz.instantialize(this, arguments);}, J.renderbio, "BioMeshRenderer", J.render.MeshRenderer);
...
function(i, tension){
try {
if ((this.meshes[i] == null || !this.meshReady[i]) && !this.createMesh(i, this.bsr.madBeg, this.bsr.madMid, this.bsr.madEnd, 1, tension)) return false;
this.meshes[i].setColix(this.bsr.colix);
this.bsRenderMesh.set(i);
return true;
} catch (e) {
