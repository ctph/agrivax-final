...
Clazz.load(["J.render.ShapeRenderer"], "J.renderspecial.PolyhedraRenderer", ["JU.P3", "$.V3", "JU.C", "$.MeshSurface"], function(){
...
Clazz.instantialize(this, arguments);}, J.renderspecial, "PolyhedraRenderer", J.render.ShapeRenderer);
...
var elemNos = (p.pointScale > 0 ? p.getElemNos(false) : null);
