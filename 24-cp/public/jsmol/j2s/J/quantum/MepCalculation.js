...
Clazz.load(["J.quantum.QuantumCalculation"], "J.quantum.MepCalculation", ["java.util.Hashtable", "JU.PT", "$.Rdr", "JU.Logger", "JV.FileManager"], function(){
...
Clazz.instantialize(this, arguments);}, J.quantum, "MepCalculation", J.quantum.QuantumCalculation);
...
try {
br = (data == null ? JV.FileManager.getBufferedReaderForResource(this.vwr, J.quantum.MepCalculation, "J/quantum/", resourceName) : JU.Rdr.getBR(data));
var line;
