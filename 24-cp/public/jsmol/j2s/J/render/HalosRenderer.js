...
Clazz.instantialize(this, arguments);}, J.render, "HalosRenderer", J.render.ShapeRenderer);
...
if (halos.atomWarning == null && halos.mads == null && halos.bsHighlight == null && !selectDisplayTrue) return false;
...
var bsWarning = (halos.atomWarning == null ? null : this.vwr.ms.getEquivalentAtoms(halos.atomWarning.intValue()));
for (var i = this.ms.ac; --i >= 0; ) {
var atom = atoms[i];
if (atom == null || (atom.shapeVisibilityFlags & 1) == 0) continue;
var isHidden = this.ms.isAtomHidden(i) || JU.C.isTransparent(atom.colixAtom);
this.mad = (isHidden || halos.mads == null ? 0 : halos.mads[i]);
