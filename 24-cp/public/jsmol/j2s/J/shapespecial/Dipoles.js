...
Clazz.load(["J.shape.Shape", "JU.P3"], "J.shapespecial.Dipoles", ["java.util.Hashtable", "JU.AU", "$.Lst", "$.PT", "$.SB", "$.V3", "JS.T", "J.shapespecial.Dipole", "JU.C", "$.Logger"], function(){
...
if (this.currentDipole == null) this.setPropertyTok(268441090, this.isBond, 0, offsetPercent / 100);
return;
...
this.setPropertyTok(1111490588, this.isBond, (value.equals("translucent") ? 1 : 0), 0);
return;
