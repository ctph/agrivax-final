...
Clazz.load(["J.shape.AtomShape"], "J.shapebio.BioShape", ["JU.AU", "$.BS", "$.PT", "J.c.PAL", "$.STR", "JU.BSUtil", "$.C", "$.Logger"], function(){
...
this.range = 0;
this.floatRange = 0;
Clazz.instantialize(this, arguments);}, J.shapebio, "BioShape", J.shape.AtomShape);
