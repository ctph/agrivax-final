...
Clazz.load(["J.export.___Exporter"], "J.export.__RayTracerExporter", null, function(){
var c$ = Clazz.decorateAsClass(function(){
this.isSlabEnabled = false;
this.minScreenDimension = 0;
this.wasPerspective = false;
Clazz.instantialize(this, arguments);}, J["export"], "__RayTracerExporter", J["export"].___Exporter);
