...
Clazz.load(["JU.P3", "$.V3"], "J.export.___Exporter", ["java.util.Hashtable", "JU.AU", "$.Lst", "$.M3", "$.Quat", "$.SB", "JU.C", "$.Logger", "$.MeshSurface"], function(){
...
this.nImage = 0;
this.lineWidthMad = 0;
Clazz.instantialize(this, arguments);}, J["export"], "___Exporter", null);
