...
;//5.0.1-v7 Fri May 30 04:05:41 CDT 2025
Clazz_declarePackage("J.api");
Clazz_declareInterface(J.api, "JmolScriptFunction");
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
Clazz_declarePackage("J.api");
(function(){
var c$ = Clazz_declareInterface(J.api, "JmolScriptManager");
})();
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["J.thread.JmolThread"], "JS.CommandWatcherThread", ["JU.Logger"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.scriptManager = null;
Clazz_instantialize(this, arguments);}, JS, "CommandWatcherThread", J.thread.JmolThread);
...
this.cacheName = null;
this.key = null;
Clazz_instantialize(this, arguments);}, JS, "FileLoadThread", J.thread.JmolThread);
Clazz_makeConstructor(c$, 
...
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["JS.ScriptTokenParser", "JU.Lst"], "JS.ScriptCompiler", ["java.util.Hashtable", "JU.AU", "$.BS", "$.PT", "$.SB", "J.api.Interface", "J.i18n.GT", "JM.BondSet", "$.Group", "JS.ContextToken", "$.SV", "$.ScriptContext", "$.ScriptError", "$.ScriptFlowContext", "$.ScriptFunction", "$.ScriptManager", "$.T", "JU.Edge", "$.Escape", "$.Logger", "JV.FileManager", "$.JC", "$.Viewer"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.filename = null;
this.isSilent = false;
...
this.chFirst = '\0';
this.afterMath = 0;
Clazz_instantialize(this, arguments);}, JS, "ScriptCompiler", JS.ScriptTokenParser);
...
this.isStateScript = (this.ichToken >= 0 && this.ichToken < 10);
...
this.haveENDIF = (this.script.indexOf("endif") >= 0);
...
this.cchToken = 0;
continue;
}if (this.lookingAtImpliedString(true, true, true, false)) this.ichEnd = this.ichToken + this.cchToken;
...
ichFirstSharp = ichT;
}if (ch == '/' && ichT + 1 < this.cchScript) switch ((this.script.charAt(++ichT)).charCodeAt(0)) {
case 47:
...
if (this.nTokens > 2 ? !(this.tokAt(2) == 268435968 && this.ltoken.get(1).value.toString().endsWith(".spt")) : s.endsWith(".SORT") || s.endsWith(".REVERSE") || s.endsWith(".POP") || s.indexOf(".SORT(") >= 0 || s.indexOf(".REVERSE(") >= 0 || s.indexOf(".POP(") >= 0 || s.indexOf(".PUSH(") >= 0 || s.endsWith("++") || s.endsWith("--") || s.endsWith("=") || this.tokInitialPlusPlus != 0) {
...
var i = 0;
for (i = 1; i < size; i++) {
if ((j = this.tokAt(i)) == 268442114) break;
}
size = i;
i++;
...
if (this.ident.equals("NaN")) {
this.addTokenToPrefix(JS.SV.vNaN);
return 3;
...
this.theToken = null;
} else if (this.ident.length == 1 || this.lastToken.tok == 268436482) {
...
var str = this.getUnescapedStringLiteral(this.lastToken != null && !this.iHaveQuotedString && this.lastToken.tok != 1073741984 && (this.tokCommand == 36867 && this.nTokens == 2 && this.lastToken.tok == 545259546 || this.tokCommand == 134223363 || this.tokCommand == 1610616835 || this.tokCommand == 134222850 || this.tokCommand == 4124));
this.iHaveQuotedString = true;
if ((this.tokCommand == 134223363 || this.tokCommand == 135174) && this.lastToken.tok == 134221834 || this.tokCommand == 134221834 && str.indexOf("@") < 0) {
if (!this.getData(str)) {
...
if (!this.iHaveQuotedString && this.lookingAtImpliedString(this.tokCommand == 134222350, this.tokCommand == 134223363, this.nTokens > 1 || this.tokCommand != 134222850 && this.tokCommand != 4124, false)) {
var str = this.script.substring(this.ichToken, this.ichToken + this.cchToken);
if (this.tokCommand == 134222850) {
if (str.startsWith("javascript:")) {
this.lookingAtImpliedString(true, true, true, false);
...
case 603983903:
if (this.nTokens == 2 && this.lastToken.tok == 134217764) {
if (this.lookingAtImpliedString(false, false, false, true)) {
if (this.script.charAt(this.ichToken + this.cchToken - 1) == ';') --this.cchToken;
var s = this.script.substring(this.ichToken, this.ichToken + this.cchToken);
this.addTokenToPrefix(JS.T.o(4, s));
return 2;
}}break;
case 134221856:
...
this.iHaveQuotedString = true;
return 0;
}if (this.lookingAtImpliedString(true, true, true, false)) {
var str = this.script.substring(this.ichToken, this.ichToken + this.cchToken);
...
if (this.implicitString && !((this.tokCommand == 134222850 || this.tokCommand == 4124) && this.iHaveQuotedString) && this.lookingAtImpliedString(true, true, true, false)) {
var str = this.script.substring(this.ichToken, this.ichToken + this.cchToken);
...
return 2;
}var value = this.lookingAtExponential();
if (value != null) {
this.addNumber(3, 2147483647, value);
return 2;
}if (this.lookingAtDecimal()) {
value = Float.$valueOf(this.script.substring(this.ichToken, this.ichToken + this.cchToken));
var intValue = (JU.Edge.getFloatEncodedInt(this.script.substring(this.ichToken, this.ichToken + this.cchToken)));
this.addNumber(3, intValue, value);
return 2;
...
case 268441602:
if (this.nTokens == 0) {
this.tokInitialPlusPlus = this.theToken.tok;
return 2;
...
this.addTokenToPrefix(JS.T.tokenEquals);
this.addTokenToPrefix(token);
this.addTokenToPrefix(tok == 268441601 ? JS.T.tokenMinus : JS.T.tokenPlus);
...
case 268435968:
this.parenCount++;
if (this.nTokens > 1 && (this.lastToken.tok == 1275082241 || this.lastToken.tok == 134320648 || this.lastToken.tok == 134320649)) this.nSemiSkip += 2;
break;
case 1073742338:
...
function(){
var name = (this.nTokens == 0 ? "" : this.ltoken.get(0).value.toString());
if (this.nTokens > 0 && !this.isContextVariable(name.toLowerCase())) return false;
...
this.isEndOfCommand = true;
this.cchToken = 0;
if (this.theTok == 268435968) this.parenCount--;
return 2;
}switch (this.theTok) {
case 1073742332:
break;
...
switch (this.nTokens) {
case 1:
if (this.theTok != 268435968) return this.ERROR(15, "(");
break;
case 2:
if (this.theTok != 268435969) (this.tokenCommand).name0 = this.ident;
this.newContextVariable(this.ident);
break;
case 3:
if (this.theTok != 268435969) return this.ERROR(15, ")");
this.isEndOfCommand = true;
...
if (this.theTok != 268435968) return this.ERROR(15, "(");
break;
}if (this.nTokens == 3 && this.theTok == 268435969) break;
if (this.nTokens % 2 == 0) {
if (this.theTok != 268436992 && this.theTok != 268435969) return this.ERROR(15, ")");
break;
}this.thisFunction.addVariable(this.ident, true);
break;
case 102411:
if (this.nTokens > 1 && this.parenCount == 0 && this.braceCount == 0 && this.theTok == 268436482) {
this.addTokenToPrefix(JS.T.tokenRightParen);
this.braceCount = 1;
this.isEndOfCommand = true;
this.cchToken = 0;
...
case 134320648:
if (this.nTokens == 1) {
if (this.theTok != 268435968) return this.ERROR(19, this.ident);
...
if (this.theTok == 268435968 || this.isUserFunction(token.value.toString())) {
this.ltoken.set(0, this.setCommand(JS.T.tv(1073741824, 0, token.value)));
this.setBraceCount = 0;
break;
}if (this.theTok != 1111490588 && this.theTok != 1073741824 && this.theTok != 268442114 && this.theTok != 12290 && (!JS.T.tokAttr(this.theTok, 536870912))) {
if (this.isNewSet) this.commandExpected();
 else this.errorIntStr2(18, "SET", ": " + this.ident);
return 4;
}if (this.nTokens == 1 && (this.lastToken.tok == 268441602 || this.lastToken.tok == 268441601)) {
this.replaceCommand(JS.T.tokenSet);
...
return ((isSetBrace || this.theToken.tok == 268435968 || this.theToken.tok == 536870918 || this.theToken.tok == 268441602 || this.theToken.tok == 268441601) ? this.theToken : JS.T.o(1073741824, ident));
}, "~B,~S");
...
function(ch){
return ch == ' ' || ch == '\t' || ch.charCodeAt(0) == 0x2002 || ch.charCodeAt(0) == 0xA0;
}, "~S");
...
switch ((this.script.charAt(ichT)).charCodeAt(0)) {
case 123:
nParen++;
break;
case 125:
...
if (s.indexOf(JV.JC.BASE64_TAG) != 0) return s;
...
function(allowSpace, allowEquals, allowSptParen, allowSemicolon){
var ichT = this.ichToken;
...
var isOK = true;
var parenpt = 0;
while (isOK && (!this.eol(ch = this.charAt(ichT)) || allowSemicolon && ch == ';')) {
switch ((ch).charCodeAt(0)) {
case 59:
if (ichT + 5 > this.cchScript || ichT + 2 < this.cchScript && (".01234567890-".indexOf(this.script.charAt(ichT + 1)) < 0 || this.script.charAt(ichT + 2) == '-')) {
isOK = false;
continue;
}break;
case 40:
...
function(){
if (this.ichToken == this.cchScript) return null;
var ichT = this.ichToken;
var pt0 = ichT;
...
if (ichT == this.cchScript || !isOK) return null;
isOK = (ch != 'E' && ch != 'e');
if (isOK || ++ichT == this.cchScript) return null;
ch = this.script.charAt(ichT);
if (ch == '-' || ch == '+') ichT++;
...
if (!isOK) return null;
this.cchToken = ichT - this.ichToken;
return Float.$valueOf(JU.PT.dVal(this.script.substring(pt0, ichT)));
});
...
this.tokLastMath = 0;
var ch;
switch ((ch = this.script.charAt(ichT++)).charCodeAt(0)) {
case 45:
case 43:
case 38:
case 124:
...
Clazz_instantialize(this, arguments);}, JS, "ScriptDelayThread", J.thread.JmolThread);
Clazz_makeConstructor(c$, 
...
break;
case -2:
if (this.doPopPush) this.vwr.pushHoldRepaintWhy("scriptdelaythread FINISH");
if (this.isPauseDelay) this.eval.notifyResumeStatus();
if (this.script != null) {
(this.eval).popContext(false, false);
this.vwr.script(this.script);
return;
}this.resumeEval();
return;
}
...
;//5.0.1-v7 Thu May 29 17:57:11 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["J.api.JmolScriptEvaluator"], "JS.ScriptError", ["JU.PT", "J.i18n.GT", "JS.ScriptException"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.vwr = null;
this.chk = false;
...
Clazz_instantialize(this, arguments);}, JS, "ScriptError", null, J.api.JmolScriptEvaluator);
...
Clazz_defineMethod(c$, "invArgStr", 
function(msg){
this.errorOrWarn(22, msg, null, null, false);
}, "~S");
...
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["JS.ScriptExpr"], "JS.ScriptEval", ["java.util.Arrays", "$.Hashtable", "JU.AU", "$.BArray", "$.BS", "$.Base64", "$.Lst", "$.M3", "$.M4", "$.Measure", "$.P3", "$.P4", "$.PT", "$.Quat", "$.SB", "$.V3", "J.api.Interface", "J.atomdata.RadiusData", "J.c.PAL", "$.STR", "$.VDW", "J.i18n.GT", "JM.BondSet", "$.Group", "$.Measurement", "JS.FileLoadThread", "$.SV", "$.ScriptCompiler", "$.ScriptContext", "$.ScriptDelayThread", "$.ScriptInterruption", "$.ScriptManager", "$.ScriptMathProcessor", "$.T", "JU.BSUtil", "$.ColorEncoder", "$.Edge", "$.Elements", "$.Escape", "$.Font", "$.Logger", "$.Parser", "$.SimpleUnitCell", "JV.ActionManager", "$.FileManager", "$.JC", "$.StateManager", "$.Viewer"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.sm = null;
this.isJS = false;
...
this.pcResume = -1;
Clazz_instantialize(this, arguments);}, JS, "ScriptEval", JS.ScriptExpr);
Clazz_makeConstructor(c$, 
function(){
...
function(allowWaitFor){
return (!this.chk && (allowWaitFor && this.vwr.g.waitForMoveTo || !this.vwr.headless && !this.vwr.autoExit && this.vwr.haveDisplay && this.outputBuffer == null && this.allowJSThreads));
}, "~B");
...
this.vwr.popHoldRepaint("CLEAR HOLD - executeCommands" + " " + (this.scriptLevel > 0 ? "\u0001## REPAINT_IGNORE ##" : ""));
if (haveError) this.resumeViewer("exception", true);
...
this.resumeViewer("resumeEval", this.executionStopped);
return;
}this.thisContext = sc;
...
var pc = (sc.lineNumbers == null ? sc.pc : Math.min(sc.pc, sc.lineNumbers[sc.lineNumbers.length - 1]));
...
this.executionPaused = false;
this.executionStepping = false;
if (!this.tQuiet) this.vwr.setScriptStatus("Jmol script resumed", this.errorMessage, 1 + (this.timeEndExecution - this.timeBeginExecution), "resumed");
});
...
var len = s.length;
if (pt1 == len - 1 && s.endsWith("}")) pt1++;
return (pt0 >= len || pt1 < pt0 || pt1 < 0 ? "" : s.substring(Math.max(pt0, 0), Math.min(len, pt1)));
...
if (this.compileScript(null, (compileOnly ? "w_h_e_r_e" : "e_x_p_r_e_s_s_i_o_n") + " = " + expr, false)) {
...
}} else if (Clazz_instanceOf(expr,Array) && Clazz_instanceOf((expr)[0],Array)) {
...
var sc = this.compiler.compile(filename, strScript, false, false, debugCompiler && JU.Logger.debugging, false);
this.addFunction(null);
var pf = this.privateFuncs;
this.restoreScriptContext(sc, false, false, false);
this.privateFuncs = null;
if (this.thisContext != null) this.thisContext.privateFuncs = pf;
...
var path = scriptPath;
if (scriptPath == null) {
path = this.vwr.fm.getFilePath(filename, false, false);
scriptPath = path.substring(0, Math.max((pt = path.lastIndexOf("|")), path.lastIndexOf("/")));
if (pt > 0) {
script = this.checkFixBondDelete(script);
this.vwr.setAccessInternal(path.substring(0, pt));
}}return JV.FileManager.setScriptFileReferences(script, localPath, remotePath, scriptPath) + movieScript;
}, "~S,~S,~S,~S");
Clazz_defineMethod(c$, "checkFixBondDelete", 
function(script){
var pt = script.indexOf("select BONDS ({");
if (pt < 0) return script;
var pt2 = script.indexOf("delete ({", pt + 20);
if (pt2 < 0) return script;
var line1 = script.substring(pt, script.indexOf("\n\n", pt) + 2);
pt2 = script.indexOf("\n", pt2);
...
context.isEditor = this.isEditor;
...
}if (context.privateFuncs != null) this.privateFuncs = context.privateFuncs;
...
this.isEditor = context.isEditor;
if (isPopContext) {
...
sx.message += s;
sx.untranslated += s;
}var done = (isThrown || this.thisContext != null || this.chk || msg.indexOf("NOTE: file recognized as a script file: ") >= 0);
this.resumeViewer(isThrown ? "throw context" : "scriptException", isThrown);
if (done) return;
this.isFuncReturn = false;
if (s.indexOf("w_h_e_r_e =") < 0) JU.Logger.error("eval ERROR: " + s + "\n" + this.toString());
...
if (i != 0) sb.appendC(' ');
if (i == 2 && setEquals) {
if ((setEquals = (token.tok != 268440324)) || statement[0].intValue == 35) {
sb.append(setEquals ? "= " : "== ");
if (!setEquals) continue;
}}var tval = token.value;
switch (token.tok) {
case 1073742325:
...
if (tval != null) sb.append(token.value.toString());
if (iTok == i) sb.append("<<<<");
}
return sb.toString();
}, "JV.Viewer,~A,~N,~B");
...
function(s, isError){
if (this.chk || isError && s.indexOf(" of try:") >= 0) return;
...
if (!this.isJS) {
Thread.yield();
}if (this.isEditor && doShowPC) this.notifyScriptEditor(this.pc);
doShowPC = false;
...
if (!script.startsWith("resume\1") && !script.startsWith("step\1")) this.pauseExecution(false);
}this.doDelay(-100, null);
...
function(millis){
this.delayScriptAndRun(millis, null);
}, "~N");
Clazz_defineMethod(c$, "delayScriptAndRun", 
function(millis, script){
...
this.scriptDelayThread.setScript(script);
if (this.isJS && this.allowJSThreads) {
this.pc = this.aatoken.length;
}this.scriptDelayThread.run();
}, "~N,~S");
Clazz_defineMethod(c$, "doDelay", 
function(millis, script){
if (!this.useThreads(false)) return;
if (this.isJS) throw  new JS.ScriptInterruption(this, "delay" + (script == null ? "" : ":" + script), millis);
this.delayScriptAndRun(millis, script);
}, "~N,~S");
...
var isInterrupt = (this.$error || this.executionStopped);
this.vwr.scriptStatus("script execution " + (isInterrupt ? "interrupted" : "resumed"));
}});
...
if (this.isJS && doDelay) this.doDelay(10, null);
}, "~B");
...
}var allowJSInterrupt = (this.isJS && !fromFunc && this.useThreads(false) && this.vwr.getInt(536870922) >= 0);
...
if (allowJSInterrupt) {
if (!this.executionPaused && System.currentTimeMillis() - lastTime > 1000000) {
this.pc--;
this.doDelay(-1, null);
}lastTime = System.currentTimeMillis();
}if (!this.chk && (!this.executionStepping || !isFirst) && !this.checkContinue()) break;
isFirst = false;
...
if (!this.isJS && this.isEditor && this.scriptLevel == 0) {
this.notifyScriptEditor(this.pc);
try {
Thread.sleep(100);
} catch (e) {
if (Clazz_exceptionOf(e,"InterruptedException")){
...
this.setCursorWait(false);
if (tok != 266298 && this.executionStepping) {
...
function(pc){
this.vwr.notifyScriptEditor((this.lineIndices[pc][0] << 16) | this.lineIndices[pc][1], null);
}, "~N");
...
index = this.iToken;
this.setShapeProperty(34, "axes2", (this.tokAt(index + 1) == 4 ? this.stringParameter(++index) : null));
...
return;
}o = (file.startsWith(JV.JC.BASE64_TAG) ?  new JU.BArray(JU.Base64.decodeBase64(file)) : file);
}
if (this.vwr.fm.loadImage(o, null, !this.useThreads(false))) throw  new JS.ScriptInterruption(this, "backgroundImage", 1);
return;
...
this.vwr.setBackgroundImage(null, null);
return;
}this.colorShape(-this.theTok, i + 1, true);
}, "~N");
...
break;
default:
if ((order = JU.Edge.getBondOrderFromString(this.paramAsStr(1))) == 131071) this.invArg();
if (order == 33 && this.tokAt(2) == 3) {
order = JU.Edge.getPartialBondOrderFromFloatEncodedInt(this.st[2].intValue);
}}
...
index = this.iToken + 1;
var scale = 1;
if (this.tokAt(index) == 536875059) {
scale = this.floatParameter(++index);
index++;
if (index == this.slen) {
if (!this.chk) this.vwr.ms.setBoundBox(null, null, true, scale);
return;
}} else if (this.tokAt(index) == 4141) {
if (!this.chk) this.vwr.ms.setBoundBox(null, null, true, 0);
return;
...
return;
}if (this.slen == 4 && this.tokAt(2) == 1814695966) i = 2;
...
i = this.iToken + 1;
}var isTranslucent = (this.tokAt(i) == 1111490588);
...
}this.colorShape(-this.theTok, i, false);
});
Clazz_defineMethod(c$, "cmdDefine", 
function(){
if (this.slen < 3 || !((typeof(this.getToken(1).value)=='string'))) this.invArg();
...
this.refresh(false);
this.doDelay(Math.abs(millis), (this.slen == 3 && this.tokAt(2) == 4 ? JS.SV.sValue(this.getToken(2)) : null));
});
...
}if (doRefresh && this.vwr.getRefreshing() && text != null && !text.startsWith("%SCALE")) this.showString(this.vwr.formatText(text));
}, "~N");
...
if (!isMinusMinus && this.getToken(++j).tok != 268440324) this.invArg();
if (isMinusMinus) j -= 2;
...
case 134320141:
case 102436:
this.addFunction(this.theToken.value);
return isForCheck;
case 102412:
this.popContext(true, false);
break;
...
var isScale = (this.tokAt(1) == 536875059);
if (shapeType == -1) shapeType = (isScale ? 31 : this.getShapeType(this.getToken(1).tok));
if (shapeType == 5) {
if (fontsize == 0 || fontsize >= 1 && (fontsize < 6 || fontsize > 63)) {
this.integerOutOfRange(6 - sizeAdjust, 63 - sizeAdjust);
return;
}if (!this.chk) this.setShapeProperty(5, "setDefaults", fontsize == 0 ? this.vwr.slm.noneSelected : Boolean.FALSE);
}if (this.chk) return;
var value;
if (name === "font") {
...
fontstyle = fontface;
fontface = "SansSerif";
}value = this.vwr.getFont3D(fontface, fontstyle, fontsize);
} else {
value = Float.$valueOf(fontsize);
}this.sm.loadShape(shapeType);
if (isScale) this.setShapeProperty(31, "target", "%SCALE");
this.setShapeProperty(shapeType, name, value);
if (scaleAngstromsPerPixel >= 0) this.setShapeProperty(shapeType, "scalereference", Float.$valueOf(scaleAngstromsPerPixel));
if (isScale) this.setShapeProperty(31, "thisID", null);
}, "~N,~N");
...
if (this.tokAt(1) == 268440324 && this.tokAt(2) == 1073742333) {
this.vwr.removeFunction(name);
return;
}if (!this.isFunction(name)) this.error(10);
var params = (this.slen == 1 || this.slen == 3 && this.tokAt(1) == 268435968 && this.tokAt(2) == 268435969 ? null : this.parameterExpressionList(1, -1, false));
if (this.chk) return;
...
modelName = this.optParameterAsString(i + 1);
isAppend = key.startsWith("append");
if (isAppend && key.startsWith("append modelindex=")) {
var ami = JU.PT.parseInt(key.substring(18));
if (ami >= 0) {
appendNew = false;
htParams.put("appendToModelIndex", Integer.$valueOf(ami));
...
if (isSmiles && this.tokAt(i + 1) == 1073741940) {
++i;
filter = this.stringParameter(++i);
}if (this.slen == i + 1) {
if (filename == null && (i == 0 || filenames == null && (filename = this.paramAsStr(filePt)).length == 0)) filename = this.getFullPathName(true);
...
if (filename == null && (filename = this.paramAsStr(filePt)).length == 0 && (filename = this.getFullPathName(true)) == null) {
this.cmdZap(false);
return;
...
if (i == 1) {
if (this.tokAt(i + 1) == 268440577 || this.tokAt(i + 1) == 268440576) {
modelName = "files";
} else {
i++;
}loadScript.append(" " + modelName);
}if (this.tokAt(i + 1) == 268440576) isConcat = true;
...
if (filename == null) this.error(57);
...
if (!this.$isStateScript && !isAppend && !this.vwr.getBoolean(603979831)) this.vwr.setBooleanProperty("legacyJavaFloat", false);
...
this.finalizeLoad(isAppend, appendNew, isConcat, doOrient, nFiles, ac0, modelCount0, isData);
});
...
if (!strModel.startsWith(JV.JC.BASE64_TAG)) strModel = JV.Viewer.fixInlineString(strModel, this.vwr.getInlineChar());
...
function(isAppend, appendNew, isConcat, doOrient, nFiles, ac0, modelCount0, isData){
...
if (this.getToken(offset).tok == 268440576) {
++offset;
...
var iFrame = (this.theTok == 4 ? JU.Edge.getFloatEncodedInt(this.theToken.value) : this.theToken.intValue);
...
if (this.chk) return;
this.refresh(false);
if (!this.useThreads(true)) floatSecondsTotal = 0;
...
case 134217750:
case 1073741918:
var v = this.planeParameter(i, false);
var x = JU.V3.new3(0, 0, 1);
x.cross(x, v);
if (x.length() < 0.001) {
x.set(0, 1, 0);
x.cross(x, v);
}v.cross(x, v);
q = JU.Quat.getQuaternionFrame(null, v, x).inv();
i = this.iToken + 1;
break;
case 1073741854:
...
if (uc == null) {
uc = this.vwr.getSymTemp().setUnitCellFromParams(null, false, NaN);
...
case 36865:
if (this.outputBuffer != null) this.outputBuffer.setLength(0);
return;
case 134221829:
this.vwr.cacheClear();
return;
...
return;
case 135198:
this.vwr.rotateModelSpinVectors(-1, null);
return;
}
...
var is2d = this.vwr.is2D();
if (isSpin && is2d) return;
...
var checkModelKit = false;
for (var i = 1; i < this.slen; ++i) {
switch (tok = this.getToken(i).tok) {
case 528432:
case 4145:
checkModelKit = (this.vwr.getOperativeSymmetry() != null);
continue;
case 12290:
case 10:
case 1073742325:
...
if (isVector) {
if (nPoints == 1) this.invArg();
rotAxis = JU.V3.newV(this.getPoint3f(i, true, true));
if (isSpin && this.slen == this.iToken + 1) {
degreesPerSecond = 2;
}break;
}var pt1 = this.centerParameterForModel(i, this.vwr.am.cmi, null);
if (!this.chk && tok == 1073742330 && this.tokAt(i + 2) != 268437504) {
isMolecular = true;
...
isVector = true;
isMolecular = true;
m3 = this.getMatrixParam(i + 1, 3, false);
if (m3 == null) {
var p4 = this.getPoint4fNoError(i + 1);
if (p4 != null) {
q = JU.Quat.newP4(p4);
}}i = this.iToken;
...
pts = this.getPointArray(++i, -1, false, true);
i = this.iToken;
} else {
pts =  new Array(3);
for (var j = 0; j < 3; j++) {
...
this.vwr.invertAtomCoord(invPoint, null, bsAtoms, -1, false);
...
if (!isMolecular) {
if (requiresThread && bsAtoms == null && !this.useThreads(true)) {
isSpin = false;
...
if (checkModelKit) {
if (endDegrees == 0) return;
if (bsAtoms == null || nPoints != 2 || isSpin || translation != null || dihedralList != null || ptsB != null || is4x4) this.invArg();
var na = this.vwr.getModelkit(false).cmdRotateAtoms(bsAtoms, points, endDegrees);
if (this.doReport()) this.report(J.i18n.GT.i(J.i18n.GT.$("{0} atoms rotated"), na), false);
return;
...
this.vwr.setAtomCoords(bsAtoms, 1145047049, ptsB);
} else {
if (requiresThread && !this.useThreads(false)) return;
if (isVector) {
if (model < 0 && this.vwr.am.cmi < 0) this.errorStr(30, "rotate VECTOR");
if (q == null && endDegrees == 1.7976931348623157E308) this.invArg();
var deg = (isSpin ? degreesPerSecond : endDegrees);
if (q == null) {
q = (m3 == null ? JU.Quat.newVA(rotAxis, deg) : JU.Quat.newM(m3));
}m3 = q.getMatrix();
if (rotAxis.lengthSquared() == 0) {
m3.m00 = NaN;
}if (Float.isNaN(m3.getElement(0, 0))) m3.setElement(1, 1, deg);
if (!isSpin || degreesPerSecond <= 0) {
this.vwr.tm.setSpinOff();
this.vwr.rotateModelSpinVectors(model, m3);
return;
}}if (this.vwr.rotateAboutPointsInternal(this, points[0], points[1], rate, endDegrees, isSpin, bsAtoms, translation, ptsB, dihedralList, (isVector ? m3 : null), is4x4 ? m4 : null, false, null) && this.isJS && isSpin) {
throw  new JS.ScriptInterruption(this, "rotate", 1);
}}}, "~B,~B");
...
if (this.chk) return;
var state;
state = this.vwr.stm.getSavedState(saveName);
if (state == null) {
if (saveName.equalsIgnoreCase("UNDO")) return;
this.invArg();
...
return;
case 1814695966:
if (!this.chk) this.vwr.stm.restoreUnitCell(saveName);
return;
}
...
return;
case 1814695966:
if (!this.chk) this.vwr.stm.saveUnitCell(saveName);
return;
}
...
if (tok == 134238732) {
if (this.vwr.haveAccessInternal(null)) this.error(10);
this.checkLength(2);
...
if (this.getToken(i).tok == 268440576) lineEnd = (this.checkToken(++i) ? this.intParameter(i++) : 0);
...
pcEnd = pc + 1;
if (this.checkToken(i)) {
if (this.getToken(i).tok == 268440576) pcEnd = (this.checkToken(++i) ? this.intParameter(i++) : 0);
...
var isPNGJ = false;
if (theScript == null) {
theScript = this.getScriptFileInternal(filename, localPath, remotePath, scriptPath);
if (theScript == null) this.invArg();
isPNGJ = this.vwr.haveAccessInternal(null);
}if (this.isMenu(theScript)) {
this.vwr.setMenu(theScript, false);
return;
...
if (this.compileScript(filename, theScript, filename != null && this.debugScript)) {
this.pcEnd = pcEnd;
...
this.dispatchCommands(false, false, false);
if (this.$isStateScript) JS.ScriptManager.setStateScriptVersion(this.vwr, null);
if (isPNGJ) this.vwr.setAccessInternal(null);
...
function(i){
if (this.slen == 1) {
this.vwr.selectStatus(null, false, 0, !this.doReport(), false);
return;
...
switch (tok) {
case 10:
if (Clazz_instanceOf(this.getToken(2).value,"JM.BondSet") || tok == 1677721602 && this.getToken(3).tok == 10) {
...
if (this.thisCommand != null && this.thisCommand.indexOf("/*FIXED*/") > 0) bs = this.vwr.ms.fixDeletedBonds(bs);
this.iToken++;
} else if (this.isArrayParameter(4)) {
i = -4;
} else if (this.isArrayParameter(3)) {
i = -3;
}if (i < 0) {
bs =  new JU.BS();
var a = this.expandFloatArray(this.floatParameterSet(-i, 0, 2147483647), 0, false);
...
var addRemove = 0;
var isGroup = false;
var reportStatus = (this.tokAt(i) == 268436992);
if (reportStatus) i++;
...
bs1.and(bs);
bs = bs1;
}this.vwr.selectStatus(bs, isGroup, addRemove, !this.doReport(), reportStatus);
this.vwr.slm.noneSelected = Boolean.$valueOf(this.slen == 4 && this.tokAt(2) == 1073742333);
}}, "~N");
...
if (this.chk) return;
if ((typeof(o)=='string')) {
if (this.vwr.fm.loadImage(o, "\0windowImage", !this.useThreads(false))) throw  new JS.ScriptInterruption(this, "windowImage", 1);
} else {
...
return;
case 1111490588:
if (this.slen > 3) this.checkLast(2);
this.setBooleanProperty("translucent", this.slen == 2 || JS.SV.bValue(this.getToken(2)));
return;
case 545259526:
...
modelNumber = JU.Edge.getFloatEncodedInt(modelDotted);
}if (this.chk) return;
...
if (key.length == 0 || key.charAt(0) == '_' && this.tokAt(2) != 268437504) this.error(56);
...
Clazz_defineMethod(c$, "cmdScale", 
function(pt){
if (this.chk) return;
var text = "%SCALE";
switch (this.tokAt(pt)) {
case 1073742334:
this.setShapeProperty(31, "%SCALE", null);
this.checkLast(pt);
return;
case 1073742335:
pt++;
break;
default:
var units = JM.Measurement.fixUnits(this.optParameterAsString(pt));
if (JM.Measurement.fromUnits(1, units) != 0) {
text += " " + units;
pt++;
} else {
text = null;
...
this.setShapeProperty(31, "thisID", "%SCALE");
if (this.tokAt(pt) == 0) {
this.vwr.ms.setEchoStateActive(true);
var echo = this.vwr.shm.loadShape(31);
if (echo.scaleObject == null) this.setShapeProperty(31, "target", "bottom");
} else {
this.setShapeProperty(31, "target", "%SCALE");
this.cmdSetEcho(pt);
}if (text != null) this.setShapeProperty(31, "text", text);
this.setShapeProperty(31, "thisID", null);
this.refresh(false);
}, "~N");
...
var isScale = (i > 0);
var pt = (i == 0 ? 2 : i);
switch (isScale ? 0 : this.getToken(pt).tok) {
case 1073742334:
...
switch (isScale ? this.tokAt(2) : this.getToken(2).tok) {
case 1073741974:
pt++;
case 1073741996:
case 12289:
...
if (id != null) {
if (propertyName == null && !isScale) this.setShapeProperty(31, "thisID", null);
...
break;
case 1094717454:
var modelIndex = this.modelNumberParameter(pt++);
...
pt = this.iToken + 1;
} else if (this.tokAt(pt) == 1073742333) {
pt++;
}break;
case 1073742334:
propertyName = "off";
...
id = data[0];
}if (!this.chk && this.vwr.ms.getEchoStateActive() && this.vwr.fm.loadImage(this.getToken(pt).value, id, !this.useThreads(false))) throw  new JS.ScriptInterruption(this, "setEchoImage", 1);
return;
}this.cmdEcho(pt);
return;
case 134217751:
...
var plane = null;
var str;
if (this.isCenterParameter(1) || this.tokAt(1) == 9) plane = this.planeParameter(1, false);
...
if (str.equalsIgnoreCase("hkl")) plane = this.hklParameter(3, null, true);
 else if (str.equalsIgnoreCase("plane")) plane = this.planeParameter(2, false);
...
break;
default:
plane = this.planeParameter(1, false);
}
break;
case 134219777:
plane = (this.getToken(2).tok == 1073742333 ? null : this.hklParameter(2, null, true));
break;
case 1073742118:
return;
default:
...
Clazz_defineMethod(c$, "cmdUndoRedo", 
function(tok){
var n = 1;
var len = 2;
switch (tok) {
case 603984065:
case 4139:
var state = this.vwr.stm.getUndoRedoState(tok);
if (state != null) this.runScript(state);
return;
case 4165:
case 4140:
break;
...
if (!this.chk) this.vwr.undoMoveAction(tok, n);
}, "~N");
...
this.vwr.selectStatus(null, false, 0, isQuiet, false);
}, "~B");
...
var bsCenter = null;
if (this.tokAt(i) == 1814695966 || this.isCenterParameter(i)) {
ptCenter = i;
var ret =  new Array(1);
center = this.centerParameter(i, ret);
if (Clazz_instanceOf(ret[0],"JU.BS")) bsCenter = ret[0];
...
var isScale = (Math.abs(shapeType) == 536875059);
if (isScale) {
shapeType = 31;
} else if (shapeType < 0) {
shapeType = this.getShapeType(-shapeType);
...
var isTranslucent = (this.theTok == 1111490588);
...
var isColor = (index < this.slen && this.tokAt(index) != 1073742335 && this.tokAt(index) != 1073742334);
if (isColor) {
...
this.getToken(index);
isTranslucent = (this.theTok == 1111490588);
if (isTranslucent || this.theTok == 1073742074) {
translucency = this.paramAsStr(index++);
if (isTranslucent && this.isFloatParameter(index)) translucentLevel = this.getTranslucentLevel(index++);
...
if (isPropertyExplicit && JS.T.tokAttr((tok = this.getToken(++index).tok), 1077936128) && (tok == 1086324754 || !JS.T.tokAttr(tok, 1086324736))) {
tok = this.getToken(index).tok;
var type = (tok == 1111490587 ? this.getToken(++index).value.toString() : tok == 1086324754 ? "color" : null);
if (!this.chk) {
...
scheme = this.paramAsStr(index++);
if (scheme.indexOf("/") < 0) scheme = scheme.toLowerCase();
...
if (tok == 268440577) {
index++;
} else if (this.tokAt(index + 1) == 268441090) {
...
if (tok == 268440577 || !allowAbsolute) {
...
if (haveNeg) {
var b = (asBS ? null :  Clazz_newFloatArray (n, 0));
...
for (var i = n; --i >= 0; ) bs.set(Clazz_floatToInt(a[i]) - 1);
...
r = 0;
for (var j = 0; j < 8; j++) {
var d = pts[j].distanceSquared(center);
if (d > r) r = d;
}
if (r == 0) this.invArg();
r = Math.sqrt(r);
...
function(str, argb){
var n = -1;
var isSym = (str.charAt(0) == '_');
out : while (true) {
if (isSym) {
str = str.substring(1);
for (var i = JU.Elements.elementNumberMax; --i >= 0; ) {
if (str.equalsIgnoreCase(JU.Elements.elementSymbolFromNumber(i))) {
n = i;
break out;
}}
for (var i = JU.Elements.altElementMax; --i >= 4; ) {
if (str.equalsIgnoreCase(JU.Elements.altElementSymbolFromIndex(i)) || str.equalsIgnoreCase(JU.Elements.altIsotopeSymbolFromIndex(i))) {
...
if (this.chk || n < 0) {
return false;
}this.vwr.setElementArgb(n, argb);
return true;
}, "~S,~N");
...
case 3:
case 2:
isOnly = (this.floatParameter(1) < 0 && (tok == 3 || this.tokAt(2) == 268441090));
default:
...
function(units, tok){
if (tok == 545259568 && (units.toLowerCase().endsWith("hz") || JU.PT.isOneOf(units.toLowerCase(), ";default;angstroms;au;bohr;nanometers;nm;picometers;pm;vanderwaals;vdw;"))) {
...
Clazz_defineMethod(c$, "getCurrentModelFileAsString", 
function(fname){
...
;//5.0.1-v7 Fri May 30 04:05:41 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["JS.ScriptParam"], "JS.ScriptExpr", ["java.util.Hashtable", "JU.BS", "$.CU", "$.Lst", "$.Measure", "$.P3", "$.PT", "$.SB", "J.api.Interface", "JM.AtomCollection", "$.BondSet", "$.Group", "$.ModelSet", "JS.SV", "$.ScriptMathProcessor", "$.T", "JU.BSUtil", "$.Edge", "$.Elements", "$.Escape"], function(){
var c$ = Clazz_decorateAsClass(function(){
...
this.ptTemp = null;
Clazz_instantialize(this, arguments);}, JS, "ScriptExpr", JS.ScriptParam);
...
if (!rpn.addOpAllowMath(token, (this.tokAt(i + 1) == 268435968), 0)) this.invArg();
if ((token.intValue == 134320141 || token.intValue == 102436) && this.tokAt(this.iToken + 1) != 268435968) {
...
if (isSpecialAssignment && nSquare == 1 && this.tokAt(i + 1) == 268440324) isSpecialAssignment = rpn.endAssignment();
}
switch (tok) {
case 12290:
...
break;
case 134320649:
if (this.getToken(++i).tok != 268435968) this.invArg();
...
if (this.tokAt(iEnd) != 268435969) this.invArg();
...
var dummy;
if (isFunctionOfX) {
if (this.getToken(++i).tok != 268435968 || !JS.T.tokAttr(this.getToken(++i).tok, 1073741824)) this.invArg();
...
if ((tok2 = this.tokAt(pt2)) == 268435969) np--;
 else if (tok2 == 268435968) np++;
}
}var p = 0;
var jlast = 0;
...
break out;
case 2:
if (this.tokAt(this.iToken + 1) == 1073742336 && ((tok = this.tokAt(this.iToken + 2)) == 805307393 || tok == 268441089)) {
...
break;
case 134217750:
if (this.tokAt(this.iToken + 1) == 268435968) {
...
case 1073742337:
case 1073742336:
if (isSpecialAssignment && topLevel && this.tokAt(i + 2) == 268440324) isSpecialAssignment = rpn.endAssignment();
if (ptEq == 0 && topLevel) {
switch (this.tokAt(i + 1)) {
case 0:
break;
...
allowMathFunc = new Boolean (allowMathFunc & (tokNext == 268435968 || isUserFunction)).valueOf();
if (!rpn.addOpAllowMath($var, allowMathFunc, isUserFunction ? tokNext : 0)) this.invArg();
i = this.iToken;
if ($var.intValue == 134320141 && tokNext != 268435968) {
rpn.addOp(JS.T.tokenLeftParen);
rpn.addOp(JS.T.tokenRightParen);
}break;
case 1153433601:
...
if (this.theTok == 268437504 && this.tokAt(i + 2) == 268436482) {
v = this.getAssocArray(i);
i = this.iToken;
break;
}if (JS.T.tokAttr(this.theTok, 268435456) || JS.T.tokAttr(this.theTok, 134217728) && this.tokAt(this.iToken + 1) == 268435968) {
...
var haveParens = (this.tokAt(i + 1) == 268435968);
if (!haveParens) {
if (this.chk) {
v = name;
...
v = this.getContextVariableAsVariable(name, false);
if (v == null) {
switch (name) {
case "all":
v = this.vwr.bsA();
...
break;
case 12293:
rpn.addXBs(this.vwr.getMotionFixedAtoms(null, null));
break;
case 2097192:
...
if (atomID > 0) {
bs = this.compareInt(1094713346, 268440324, atomID);
if (atomID == 2) bs.or(this.compareInt(1086326789, 268440324, 20));
rpn.addXBs(bs);
} else {
...
rpn.addXNum(code[++pc]);
break;
}var chainID = (pc + 3 < code.length && code[pc + 2].tok == 268439552 && code[pc + 3].tok == 1073742357 ? code[pc + 3].intValue : -1);
...
if ((tokWhat == 1094717448) && tok != 268440324) this.invArg();
var data = null;
...
break;
case 10:
var bs1 = (Clazz_instanceOf(value,"JM.BondSet") ? value : JU.BSUtil.copy(value));
rpn.addXBs(bs1);
break;
case 8:
rpn.addXPt(value);
...
rpn.addXObj(val);
break;
}if ((typeof(val)=='string') || Clazz_instanceOf(val,"JU.Lst")) val = this.getStringObjectAsVariable(val);
if ((typeof(val)=='string')) val = (this).lookupIdentifierValue(value);
rpn.addXObj(val);
break;
}
}
...
if ((typeof(exp)=='string') && (ret == null || (exp).startsWith("({"))) {
...
val = (isStringProperty || tokWhat == 1094717448 && v.tok != 2 ? JS.SV.sValue(v) : JS.SV.nValue(v));
t = v;
...
}}if (isStringProperty && !((typeof(val)=='string'))) {
val = "" + val;
...
tokWhat = 1228935687;
isModel = false;
}if (tokWhat == -1094717454 && tokOp == 268440324) {
...
var closer = (this.tokAt(i) == 1073742332 ? 1073742338 : 268437505);
...
i++;
if (this.tokAt(i++) != 268436482) this.invArg();
var v = this.parameterExpression(i, 0, null, false, true, -1, false, null, null, false);
if (v.size() == 0) this.invArg();
ht.put(key, JS.SV.copySafely(v.get(0)));
i = this.iToken;
if (this.tokAt(i) != 268436992) break;
}
this.iToken = i;
...
if ((a == a) != (b == b)) return (tokOperator == 268440325);
switch (tokOperator) {
case 268440323:
return a < b;
case 268440322:
...
var ac = this.vwr.ms.ac;
var isCaseSensitive = (tokOperator == 268440326 || tokWhat == 1086326788 && this.vwr.getBoolean(603979822));
...
case 268440324:
case 268440325:
return (JU.PT.isMatch(propertyValue, comparisonValue, true, true) == (tokOperator == 268440324));
case 268440326:
...
if (ival > nOps) {
if (bitsetComparator != 268440323 && bitsetComparator != 268440322) continue;
}if (bitsetComparator == 268440325) {
...
if (tok != 805307393 && !JS.T.tokAttr(tok, 1073741824)) break;
...
tok &= -481;
var info = null;
if (tok == 0) tok = (isAtoms ? 1153433601 : 1677721602);
var isPt = false;
var isHash = false;
var isInt = false;
var isString = false;
switch (tok) {
case 1275068446:
return (this.vwr.getModelSetAuxiliaryInfoForAtoms(bs)).get("models");
case 1145047049:
case 1145047055:
case 1145047050:
case 1145047053:
...
bsNew = (tok == 1153433601 ? this.vwr.ms.getAtoms(1677721602, bs) : (isAtoms ? JM.BondSet.newBS(this.vwr.getBondsForSelectedAtoms(bs)) : bs));
var i;
switch (minmaxtype) {
case 32:
...
break;
case 1086324754:
iv = (atom.getWyckoffPosition(false).charAt(0)).charCodeAt(0);
switch (iv) {
case 63:
iv = 0;
break;
...
var isExpression = (this.tokAt(1) == 1073742325 || this.tokAt(1) == 268435968);
...
var tv = JS.SV.selectItemVar(JS.SV.copySafely(v.get(nv - 1)));
if (nv > 1) {
...
return null;
}var needVariable = (!settingData && t == null && (isThrown || !((typeof(tv.value)=='string') || tv.tok == 2 || Clazz_instanceOf(tv.value, Integer) || Clazz_instanceOf(tv.value, Float) || Clazz_instanceOf(tv.value, Boolean))));
...
this.vwr.setAtomCoords(bs, tok, this.getPointArray(-1, nValues, true, true));
break;
}
return;
case 1765808134:
...
case 134320141:
case 1073741824:
if (this.tokAt(1) == 268435968) return true;
}
...
fixed[j] = JS.T.tv(3, JU.Edge.getFloatEncodedInt("" + v), v);
...
this.ichCommand = 0;
this.line0 = 0;
Clazz_instantialize(this, arguments);}, JS, "ScriptFlowContext", null);
Clazz_makeConstructor(c$, 
...
Clazz_instantialize(this, arguments);}, JS, "ScriptFunction", null, J.api.JmolScriptFunction);
Clazz_prepareFields (c$, function(){
...
var c$ = Clazz_declareType(JS, "ScriptInterruption", JS.ScriptException);
Clazz_makeConstructor(c$, 
...
;//5.0.1-v7 Thu May 29 17:54:11 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["J.api.JmolScriptManager", "JU.Lst"], "JS.ScriptManager", ["java.util.Hashtable", "JU.AU", "$.PT", "$.Rdr", "$.SB", "J.api.Interface", "J.i18n.GT", "JS.ScriptQueueThread", "JU.Elements", "$.Logger", "JV.FileManager"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.vwr = null;
this.eval = null;
this.evalTemp = null;
...
Clazz_instantialize(this, arguments);}, JS, "ScriptManager", null, J.api.JmolScriptManager);
Clazz_prepareFields (c$, function(){
...
Clazz_defineMethod(c$, "addScript", 
...
Clazz_defineMethod(c$, "evalStringWaitParamsStatusQueued", 
...
Clazz_defineMethod(c$, "evalStringParamsQuietSync", 
...
}}if (cmd == null && !noScript && this.vwr.scriptEditorVisible) this.vwr.showEditor( Clazz_newArray(-1, [fname, this.vwr.getFileAsString3(fname, true, null)]));
...
} else if (Clazz_instanceOf(br,"java.io.BufferedReader") || Clazz_instanceOf(br,"java.io.BufferedInputStream")) {
...
Clazz_overrideMethod(c$, "evalCallback", 
...
Clazz_defineMethod(c$, "runScriptFromThread", 
function(scriptItem){
...
;//5.0.1-v7 Fri May 30 04:05:41 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(null, "JS.ScriptMathProcessor", ["java.util.Hashtable", "JU.A4", "$.AU", "$.BS", "$.CU", "$.DF", "$.Lst", "$.M3", "$.M4", "$.P3", "$.P4", "$.PT", "$.Quat", "$.V3", "JM.BondSet", "JS.SV", "$.T", "JU.BSUtil", "$.Escape", "$.Logger"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.wasX = false;
this.asBitSet = false;
this.oPt = -1;
...
Clazz_instantialize(this, arguments);}, JS, "ScriptMathProcessor", null);
Clazz_prepareFields (c$, function(){
...
function(op){
return (op != null && (JS.T.tokAttr(op.tok, 134217728) && op !== JS.T.tokenArraySquare || op.tok == 268442113 && JS.T.tokAttr(op.intValue, 134217728)));
}, "JS.T");
...
var tok;
var isDotSelector = (op.tok == 268442113);
if (isDotSelector && !this.wasX) return false;
var isMathFunc = (allowMathFunc && JS.ScriptMathProcessor.isOpFunc(op));
if (this.oPt >= 1 && op.tok != 268435968 && tok0 == 134217750) tok0 = this.oStack[--this.oPt].tok;
var newOp = null;
var isLeftOp = false;
switch (op.tok) {
case 1073742195:
...
break;
case 268435969:
if (!this.wasX && this.oPt >= 1 && tok0 == 268435968 && !JS.ScriptMathProcessor.isOpFunc(this.oStack[this.oPt - 1])) return false;
break;
case 268440576:
if (!this.wasX) op = JS.SV.newV(268441600, "-");
break;
case 1275068725:
case 32:
case 64:
...
if (!this.wasX || !(tok == 268442113 || tok == 1677721602 || tok == 1153433601)) return false;
...
default:
if (isMathFunc) {
var isArgument = (this.oPt >= 1 && tok0 == 268435968);
if (isDotSelector) {
if (tokNext == 268435968) {
...
isLeftOp = true;
break;
}if (this.wasX == isLeftOp && tok0 != 268442113) {
if (!this.wasX || !allowMathFunc) return false;
if (this.addOp(JS.T.tokenComma)) return this.addOp(op);
}break;
}
while (this.oPt >= 0 && tok0 != 268436482 && (op.tok != 268441601 && op.tok != 268441602 || this.wasX) && (!isLeftOp || tok0 == 268442113 && (op.tok == 268442113 || op.tok == 268437504)) && this.checkPrecedence(tok0, op.tok) && (tok0 != 268441600 || op.tok != 268441600)) {
if (op.tok == 268435969 && tok0 == 268435968) {
if (this.xPt >= 0) this.xStack[this.xPt] = JS.SV.selectItemVar(this.xStack[this.xPt]);
this.wasX = true;
break;
}if (op.tok == 268437505 && tok0 == 1275068418) {
break;
}if (op.tok == 268437505 && tok0 == 268437504) {
...
if (newOp != null) {
this.wasX = false;
this.addX(JS.SV.newV(268440324, newOp));
}switch (op.tok) {
case 268435968:
this.parenCount++;
this.wasX = false;
...
return true;
case 268436482:
if (tok0 != 268436482) return false;
...
if (this.oStack[this.oPt].tok == 1275068418) return this.evaluateFunction(268437504);
this.oPt--;
return true;
case 268442113:
...
if (!this.wasSyntaxCheck) {
switch (this.xStack[this.xPt].tok) {
case 10:
case 7:
break;
case 11:
if (op.tok == 268438016) break;
default:
var tf = this.getX().asBoolean();
this.addX(JS.SV.getBoolean(tf));
if (tf == (op.tok == 268438016)) {
this.chk = true;
op = (op.tok == 268438016 ? JS.T.tokenOrTRUE : JS.T.tokenAndFALSE);
}break;
}
}this.wasX = false;
break;
...
Clazz_defineMethod(c$, "checkPrecedence", 
function(tok0, tok){
if (tok0 == 268439040 && this.xPt >= 0) {
switch (this.xStack[this.xPt].tok) {
case 11:
case 12:
return true;
}
}return JS.T.getPrecedence(tok0) >= JS.T.getPrecedence(tok);
}, "~N,~N");
...
if (tok == 0) tok = (op.tok == 268442113 ? op.intValue & -481 : op.tok);
...
}if (op.tok == 268440324 && (this.isArrayItem && this.squareCount == 0 && this.equalCount == 1 && this.oPt < 0 || this.oPt >= 0 && this.oStack[this.oPt] == null)) return true;
var x2;
out : switch (op.tok) {
case 268441601:
case 268441602:
switch (this.xPt >= 0 ? this.xStack[this.xPt].tok : 0) {
case 2:
case 3:
...
x1 =  new JS.SV().setv(x2);
}if (!x2.increment(op.tok == 268441602 ? 1 : -1)) return false;
if (this.ptx > this.pto) {
x1 =  new JS.SV().setv(x2);
}}this.wasX = false;
this.putX(x1);
...
case 10:
var isBond = Clazz_instanceOf(x2.value,"JM.BondSet");
var bs = JU.BSUtil.copyInvert(x2.value, (isBond ? this.vwr.ms.bondCount : this.vwr.ms.ac));
if (isBond) {
bs = JM.BondSet.newBS(bs);
} else {
JU.BSUtil.andNot(bs, this.vwr.slm.bsDeleted);
...
bs.and(x2.value);
return this.addXBs(Clazz_instanceOf(x1.value,"JM.BondSet") ? JM.BondSet.newBS(bs) : bs);
}
break;
}
...
case 11:
if (x2.tok == 8) {
return this.addXM4(JU.M4.newMV(x1.value, x2.value));
}}
return this.addXBool(x1.asBoolean() || x2.asBoolean());
case 268438017:
...
var lnew =  new JU.Lst();
for (var i = l.size(); --i >= 0; ) {
var pt1 = JU.P3.newP(JS.SV.ptValue(l.get(i)));
m4.rotTrans(pt1);
lnew.addLast(pt1);
}
return this.addXList(lnew);
}
return this.addXFloat(NaN);
case 8:
pt = JU.P3.newP(x1.value);
switch (x2.tok) {
case 8:
...
case 10:
var bs = x.value;
if (bs.isEmpty() || Clazz_instanceOf(bs,"JM.BondSet")) break;
if (bsRestrict != null) {
bs = JU.BSUtil.copy(bs);
bs.and(bsRestrict);
}var o = (bs.isEmpty() ? null : this.eval.getBitsetProperty(bs, null, 1145047049, null, null, x.value, null, false, 2147483647, false));
return o;
case 4:
...
function(x2){
if (x2.tok != 10 || Clazz_instanceOf(x2.value,"JM.BondSet")) return false;
...
return (op.intValue == 1145047050 ? this.addXPt(ptf) : this.addXFloat(op.intValue == 1111492612 ? ptf.x : op.intValue == 1111492613 ? ptf.y : ptf.z));
case 1145045003:
return this.addXStr(this.vwr.getSymStatic().staticToRationalXYZ(JU.P3.newP(x2.value), " "));
case 1111492615:
case 1111492616:
case 1111492617:
case 1145047053:
...
;//5.0.1-v7 Fri May 30 04:05:41 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(["JS.ScriptError"], "JS.ScriptParam", ["java.util.Hashtable", "JU.BS", "$.CU", "$.Lst", "$.M3", "$.M4", "$.Measure", "$.P3", "$.P4", "$.PT", "$.Quat", "$.SB", "$.V3", "JM.TickInfo", "JS.SV", "$.T", "JU.BSUtil", "$.Edge", "$.Escape", "$.Logger"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.contextVariables = null;
...
this.isBondSet = false;
Clazz_instantialize(this, arguments);}, JS, "ScriptParam", JS.ScriptError);
...
if (this.isArrayParameter(i)) {
if (isBest) {
bestPoints = this.getPointArray(i, -1, false, true);
} else if (this.tokAt(i) == 7) {
...
plane =  new JU.P4();
plane.setT(JU.P3.newA(this.floatParameterSet(i + 1, 3, 3)));
...
Clazz_defineMethod(c$, "getAtomsStartingAt", 
function(i){
var bs =  new JU.BS();
i--;
...
var offset = NaN;
if (allowOffset) {
offset = (Clazz_instanceOf(pt,"JU.P4") ? (pt).w : NaN);
...
Clazz_defineMethod(c$, "getFractionalPoint", 
function(i){
...
Clazz_defineMethod(c$, "getPoint4fNoError", 
function(i){
return this.getPointOrPlane(i, 132);
}, "~N");
...
function(i, nPoints, allowNull, throwException){
...
Clazz_defineMethod(c$, "setScriptArguments", 
function(params, isCallback){
if (this.contextVariables == null) this.contextVariables =  new java.util.Hashtable();
this.contextVariables.put("_arguments", (params == null ? JS.SV.getVariableAI( Clazz_newIntArray(-1, [])) : isCallback ? JS.SV.newV(1275068418, params) : JS.SV.getVariableList(params)));
this.contextVariables.put("_argcount", JS.SV.newI(params == null ? 0 : isCallback ? (params).length : (params).size()));
}, "~O,~B");
Clazz_defineMethod(c$, "getCallbackParameter", 
function(n){
...
Clazz_defineMethod(c$, "getMatrixParam", 
function(i, dim, throwError){
switch (this.tokAt(i)) {
case 11:
if (dim != 3) break;
return this.getToken(i).value;
case 12:
var m4 = this.getToken(i).value;
if (dim == 3) {
var m3 =  new JU.M3();
m4.getRotationScale(m3);
return m3;
...
default:
var pts = this.getPointArray(i, dim, false, false);
if (pts == null) break;
var m =  new JU.M3();
m.setRowV(0, pts[0]);
m.setRowV(1, pts[1]);
...
this.context = null;
Clazz_instantialize(this, arguments);}, JS, "ScriptProcess", null);
Clazz_makeConstructor(c$, 
...
Clazz_instantialize(this, arguments);}, JS, "ScriptProcessRunnable", null, Runnable);
Clazz_makeConstructor(c$, 
...
this.pt = 0;
Clazz_instantialize(this, arguments);}, JS, "ScriptQueueThread", J.thread.JmolThread);
Clazz_makeConstructor(c$, 
...
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
Clazz_declarePackage("JS");
Clazz_load(null, "JS.ScriptTokenParser", ["JU.Lst", "$.P3", "$.PT", "J.i18n.GT", "JS.T", "JU.Edge", "$.Logger", "$.SimpleUnitCell"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.vwr = null;
...
this.errorLine = null;
this.errorType = null;
Clazz_instantialize(this, arguments);}, JS, "ScriptTokenParser", null);
Clazz_defineMethod(c$, "compileExpressions", 
function(){
var isScriptExpression = ((this.tokCommand == 134222850 || this.tokCommand == 4124) && this.tokAt(2) == 268435968);
...
if (this.tokAt(i) == 2 && this.tokAt(i + 1) == 1073742336 && this.tokAt(i + 3) == 268440324) {
this.tokCommand = 36867;
...
if (t != null) if (!this.isMathExpressionCommand && this.lastToken.tok != 12290 || (this.lastToken.tok == 1073742336 || this.tokAt(this.itokenInfix + 1) == 268435968) && !this.isUserFunction(name)) {
...
if (!this.clauseOr(this.isCommaAsOrAllowed || !this.isMathExpressionCommand && this.tokPeekIs(268435968))) return false;
...
function(){
return this.tokPeekIs(1073742332) && !(this.tokAt(this.itokenInfix + 1) == 4 && this.tokAt(this.itokenInfix + 2) == 268436482) || !this.isMathExpressionCommand && this.tokPeekIs(268435968);
});
...
if (token.tok == 268437504 && (this.lastToken.tok == 1073742336 || this.lastToken.tok == 1073742337)) {
...
pcount--;
var tok2;
if (pcount == 1 && (tok2 = this.ltokenPostfix.get(i - 1).tok) != 268435969 && tok2 != 268437505) {
ipt = (tok == 268437504 ? i - 1 : i);
pcount = -10;
}break;
default:
...
var tok;
while ((tok = this.tokPeek()) == 268438016 || tok == 268438017 || tok == 268438018 || allowCommaAsOr && tok == 268436992) {
if (tok == 268436992 && !this.haveString) this.addSubstituteTokenIf(268436992, JS.T.tokenOr);
...
if (this.isEmbeddedExpression && this.lastToken.tok == 1073742326) return true;
while (this.tokPeekIs(268438528)) {
this.addNextToken();
if (!this.clauseNot()) return false;
}
return true;
...
if (!this.addNextTokenIf(268435969)) return this.errorStr(15, ")");
...
var haveComma = this.addNextTokenIf(268436992);
...
var tok;
if ((tok = this.tokAt(this.itokenInfix + 1)) == 268437504 || allowNumeric && tok == 1073742332) return true;
while (true) {
if (!this.addNextTokenIf(268437504)) break;
if (!this.clauseItemSelector()) return false;
if (!this.addNextTokenIf(268437505)) return this.errorStr(15, "]");
}
return true;
}, "~B");
...
function(isWithin){
this.addNextToken();
if (!this.addNextTokenIf(268435968)) return false;
...
case 1073742189:
this.addTokenToPostfix(4, this.theValue);
if (!this.addNextTokenIf(268436992)) return false;
allowComma = false;
tok = this.tokPeek();
switch (tok) {
case 0:
...
var done = false;
while (!done) {
if (tok0 != 0 && !this.addNextTokenIf(268436992)) break;
...
if (!done) this.addNextTokenIf(268436992);
}}tok = this.tokPeek();
if (done) break;
if (isCoordOrPlane) {
while (!this.tokPeekIs(268435969)) {
switch (this.tokPeek()) {
case 0:
return this.error(4);
case 268435968:
...
break;
}if (this.addNextTokenIf(2)) if (!this.addNextTokenIf(268436992)) break;
if (this.addNextTokenIf(3)) if (!this.addNextTokenIf(268436992)) break;
if (this.addNextTokenIf(3)) if (!this.addNextTokenIf(268436992)) break;
var o = this.getToken().value;
var strOrder = ((typeof(o)=='string') ? o : " ");
...
if (!this.addNextTokenIf(268436992)) break;
}if (this.addNextTokenIf(268435969)) return true;
if (!this.clauseOr(this.tokPeekIs(268435968))) return false;
if (this.addNextTokenIf(268435969)) return true;
if (!this.addNextTokenIf(268436992)) return false;
if (!this.clauseOr(this.tokPeekIs(268435968))) return false;
break;
...
}if (this.addNextTokenIf(268436992)) if (!this.clauseOr(this.tokPeekIs(268435968))) return false;
if (!this.addNextTokenIf(268435969)) return this.errorStr(15, ")");
return true;
});
...
var tok;
var nparen = 0;
while ((tok = this.tokPeek()) != 0 && tok != 268437505) {
this.addNextToken();
if (tok == 268437504) nparen++;
if (this.tokPeek() == 268437505 && nparen-- > 0) this.addNextToken();
}
return true;
});
...
this.returnToken();
return false;
}if (JS.ScriptTokenParser.tokenAttr(tokenAtomProperty, 1086324736) && tokenComparator.tok != 268440324 && tokenComparator.tok != 268440326 && tokenComparator.tok != 268440325) return this.errorStr(15, "== !=");
if (this.tokPeek() == 268437504) {
this.getToken();
this.addTokenToPostfixToken(JS.T.tokenLeftParen);
while (true) {
if (!this.addCompare(tokenAtomProperty, tokenComparator)) return false;
if (this.tokPeek() == 268436992) this.getToken();
 else if (this.tokPeek() == 268437505) break;
this.addTokenToPostfixToken(tokenComparator.tok == 268440325 ? JS.T.tokenAnd : JS.T.tokenOr);
}
this.getToken();
this.addTokenToPostfixToken(JS.T.tokenRightParen);
return true;
...
var isNegative = (this.theToken.tok == 268440576);
...
this.tokenNext();
if (tok != 8) {
if (!this.tokenNextTok(268440324)) return this.errorStr(15, "=");
...
if (this.tokPeekIs(268436992)) this.tokenNext();
...
case 268437504:
var strSpec = "";
while (this.getToken() != null && this.theToken.tok != 268437505) strSpec += this.theValue;
...
function(){
if (this.tokPeek() == 268441089) return (this.getToken() != null);
var seqToken = this.getSequenceCode(false);
if (seqToken == null) return false;
var tok = this.tokPeek();
if (tok == 268440576 || tok == 2 && this.intPeek() < 0) {
if (tok == 268440576) {
this.tokenNext();
} else {
var i = -this.intPeek();
...
}if (this.theToken.tok == 268441089) return true;
atomSpec += "" + this.theToken.value;
if (this.tokPeekIs(268441089)) {
this.tokenNext();
atomSpec += "'";
...
Clazz_load(["JV.JmolStateCreator", "java.util.Hashtable"], "JV.StateCreator", ["java.util.Arrays", "$.Date", "JU.BS", "$.Lst", "$.P3", "$.PT", "$.SB", "J.c.PAL", "$.STR", "$.VDW", "JM.AtomCollection", "$.Bond", "$.BondSet", "JS.T", "J.shape.Shape", "JU.BSUtil", "$.C", "$.ColorEncoder", "$.Edge", "$.Escape", "$.Font", "$.Logger", "JV.GlobalSettings", "$.JC", "$.StateManager", "$.Viewer"], function(){
var c$ = Clazz_decorateAsClass(function(){
...
this.temp3 = null;
this.temp4 = null;
Clazz_instantialize(this, arguments);}, JV, "StateCreator", JV.JmolStateCreator);
Clazz_prepareFields (c$, function(){
this.temp =  new java.util.Hashtable();
this.temp2 =  new java.util.Hashtable();
this.temp3 =  new java.util.Hashtable();
this.temp4 =  new java.util.Hashtable();
});
Clazz_makeConstructor(c$, 
function(){
...
if (this.vwr.tm.spinOn && !this.vwr.tm.vectorSpinOnly) this.app(sfunc, "spin on");
sfunc.append("}\n\n_setState;\n");
...
for (var i = 0; i < ms.bondCount; i++) {
if (bonds[i] != null && !models[bonds[i].atom1.mi].isModelKit) {
if (bonds[i].isHydrogen() || (bonds[i].order & 131072) != 0) {
var bond = bonds[i];
var index = bond.atom1.i;
if (bond.atom1.group.isAdded(index)) index = -1 - index;
sb.appendI(index).appendC('\t').appendI(bond.atom2.i).appendC('\t').appendI(bond.order & 131071).appendC('\t').appendD(bond.mad / 1000).appendC('\t').appendD(bond.getEnergy()).appendC('\t').append(JU.Edge.getBondOrderNameFromOrder(bond.order)).append(";\n");
}}}
...
for (var i = ms.bondCount; --i >= 0; ) if (bonds[i] != null && bonds[i].mad != 0 && (bonds[i].shapeVisibilityFlags & JM.Bond.myVisibilityFlag) == 0) bs.set(i);
...
commands.append("  set fontScaling " + this.vwr.getBoolean(603979847) + ";\n");
if (this.vwr.is2D()) {
...
this.app(str, "background IMAGE " + (global.backgroundImageFileName.startsWith(JV.JC.BASE64_TAG) ? "" : "/*file*/") + JU.PT.esc(global.backgroundImageFileName));
...
commands.append(this.vwr.getOrientation(1073742034, null, null, null).toString());
...
if (!tm.spinOn || tm.vectorSpinOnly) return s;
...
sb.append(" ticks ").appendC(tickInfo.type).append(" ").append(JU.Escape.eP(tickInfo.ticks));
...
for (var i = i0; i >= 0; i = (reportAll ? i - 1 : shape.bsSizeSet.nextSetBit(i + 1))) if (bonds[i] != null) JU.BSUtil.setMapBitSet(this.temp, i, i, "wireframe " + ((r = bonds[i].mad) == 1 ? "on" : "" + JU.PT.escF(r / 2000)));
...
var bond = bonds[i];
if (bond != null && (reportAll || (bond.order & 131072) == 0)) JU.BSUtil.setMapBitSet(this.temp, i, i, "bondOrder " + JU.Edge.getBondOrderNameFromOrder(bond.order));
}
...
var s = this.getCommands(this.temp, null, "select /*16.2*/ BONDS") + "\n";
this.clearTemp();
return s;
}, "J.shape.Sticks");
...
var haveElementKey = false;
for (var t, $t = es.objects.values().iterator (); $t.hasNext()&& ((t = $t.next ()) || true);) {
haveElementKey = new Boolean (haveElementKey | this.getEchoState(sb, t)).valueOf();
}
if (haveElementKey) sb.append("  modelkit OFF;//to check for element keys\n");
s = sb.toString();
break;
case 8:
var hs = shape;
...
var f = JU.Font.getFont3D(l.fids[i]);
if (f.fontSizeAngstroms > 0) isNeg = true;
JU.BSUtil.setMapBitSet(this.temp4, i, i, J.shape.Shape.getFontCommand("label", f));
}}
var sf = this.getCommands(null, this.temp4, "select");
if (isNeg) {
sf = "  try{\n" + sf + "  }catch{}\n";
}s = this.getCommands(this.temp, this.temp2, "select") + sf + this.getCommands(null, this.temp3, "select");
this.temp4.clear();
this.temp3.clear();
this.clearTemp();
break;
...
var text = (t == null ? null : isScale ? t.textUnformatted : t.getStateText());
if (text == null || !t.isEcho || t.target.equals("error")) return false;
var isImage = (t.image != null);
var strOff = null;
var echoCmd = "set echo ID " + JU.PT.esc(isScale ? "%SCALE" : t.target);
switch (t.valign) {
case 3:
...
}return (t.target.startsWith("_!_elkey_"));
}, "JU.SB,JM.Text");
...
if ((typeof(value)=='string')) value = JV.StateCreator.chop(JU.PT.esc(value));
...
if (!this.vwr.g.preserveState) return;
var modelIndex = (taintedAtom >= 0 && this.vwr.ms.at[taintedAtom] != null ? this.vwr.ms.at[taintedAtom].mi : this.vwr.ms.mc - 1);
switch (type) {
case 4140:
case 4165:
...
Clazz_declarePackage("JV");
(function(){
var c$ = Clazz_declareType(JV, "JmolStateCreator", null);
})();
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
})(Clazz
,Clazz.getClassName
