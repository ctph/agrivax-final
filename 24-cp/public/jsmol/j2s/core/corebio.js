...
/*if2*/;(function(){
var c$ = Clazz_declareType(JM.AlphaPolymer, "Code", Enum);
...
/*LV!1824 unnec constructor*/Clazz_defineMethod(c$, "setLoader", 
...
if ((mask & 14) == 14) m = JM.AminoMonomer.validateAndAllocate(chain, group3, seqcode, firstAtomIndex, lastAtomIndex, specialAtomIndexes, atoms);
 ...
 else if (this.checkCarbohydrate(group3)) m = JM.CarbohydrateMonomer.validateAndAllocate(chain, group3, seqcode, firstAtomIndex, lastAtomIndex);
...
for (var i = 0; i < nH; i++) this.ms.addAtom(a.mi, a.group, 1, "H", null, 0, a.getSeqID(), 0, xyz, NaN, null, 0, 0, 1, 0, null, isHetero, false, 0, null, NaN).$delete(null);
...
var serID = iterStructure.getStrandID();
...
var m;
if (bsAll != null) {
for (var i = m0, t0; i <= m1; i++) if (Clazz_instanceOf((m = models[i]),"JM.BioModel")) for (var j = 0; j < 5; j++) if ((bs = bsAll[t0 = JM.BioResolver.mytypes[j]]) != null && !bs.isEmpty()) (m).addStructureByBS(0, t0, JM.BioResolver.types[j], bs);
...
return (pt > 0 ? pt < max : max == 2147483647 && this.checkCarbohydrate(g3));
}, "~S,~N");
...
var source = temp[p++];
var target = temp[p++];
if (target.length == 1) switch ((target.charAt(0)).charCodeAt(0)) {
case 78:
target = "H@H2";
break;
case 66:
...
Clazz_defineMethod(c$, "checkCarbohydrate", 
function(group3){
if (group3 == null) return false;
var key = "[" + group3.toUpperCase() + "]";
return (",[AHR],[ALL],[AMU],[ARA],[ARB],[BDF],[BDR],[BGC],[BMA],[FCA],[FCB],[FRU],[FUC],[FUL],[GAL],[GLA],[GLC],[GXL],[GUP],[LXC],[MAN],[RAM],[RIB],[RIP],[XYP],[XYS],[CBI],[CT3],[CTR],[CTT],[LAT],[MAB],[MAL],[MLR],[MTT],[SUC],[TRE],[GCU],[MTL],[NAG],[NDG],[RHA],[SOR],[SOL],[SOE],[XYL],[A2G],[LBT],[NGA],[SIA],[SLB],[AFL],[AGC],[GLB],[NAN],[RAA]".indexOf(key) >= 0 || this.carbohydrates != null && this.carbohydrates.indexOf(key) >= 0);
}, "~S");
...
c$.ATOMID_MAX = JM.BioResolver.specialAtomNames.length;
c$.htSpecialAtoms = null;
c$.argbsAmino =  Clazz_newIntArray(-1, [0xFFBEA06E, 0xFFC8C8C8, 0xFF145AFF, 0xFF00DCDC, 0xFFE60A0A, 0xFFE6E600, 0xFF00DCDC, 0xFFE60A0A, 0xFFEBEBEB, 0xFF8282D2, 0xFF0F820F, 0xFF0F820F, 0xFF145AFF, 0xFFE6E600, 0xFF3232AA, 0xFFDC9682, 0xFFFA9600, 0xFFFA9600, 0xFFB45AB4, 0xFF3232AA, 0xFF0F820F, 0xFFFF69B4, 0xFFFF69B4, 0xFFBEA06E]);
c$.argbsNucleic =  Clazz_newIntArray(-1, [0xFFBEA06E, 0xFFA0A0A0, 0xFF0F820F, 0xFFE6E600, 0xFFE60A0A, 0xFF145AFF, 0xFF00DCDC, 0xFF00DCDC, 0xFF0F820F, 0xFFE6E600, 0xFFE60A0A, 0xFF145AFF, 0xFF00DCDC, 0xFF00DCDC, 0xFF0F820F, 0xFFE6E600, 0xFFE60A0A, 0xFF145AFF, 0xFF00DCDC, 0xFF00DCDC]);
c$.argbsChainAtom =  Clazz_newIntArray(-1, [0xFFffffff, 0xFFC0D0FF, 0xFFB0FFB0, 0xFFFFC0C8, 0xFFFFFF80, 0xFFFFC0FF, 0xFFB0F0F0, 0xFFFFD070, 0xFFF08080, 0xFFF5DEB3, 0xFF00BFFF, 0xFFCD5C5C, 0xFF66CDAA, 0xFF9ACD32, 0xFFEE82EE, 0xFF00CED1, 0xFF00FF7F, 0xFF3CB371, 0xFF00008B, 0xFFBDB76B, 0xFF006400, 0xFF800000, 0xFF808000, 0xFF800080, 0xFF008080, 0xFFB8860B, 0xFFB22222]);
c$.argbsChainHetero =  Clazz_newIntArray(-1, [0xFFffffff, -7298865, -8335464, -3174224, -3158160, -3174193, -8339264, -3170208, -4173712, -3821949, -16734257, -4895668, -11094638, -7686870, -4296002, -16730463, -16724113, -13329567, -16777029, -5922981, -16739328, -5242880, -5197824, -5242704, -16731984, -1526253, -4050382]);
c$.argbsShapely =  Clazz_newIntArray(-1, [0xFFFF00FF, 0xFF00007C, 0xFFFF7C70, 0xFF8CFF8C, 0xFFA00042, 0xFFFFFF70, 0xFFFF4C4C, 0xFF660000, 0xFFFFFFFF, 0xFF7070FF, 0xFF004C00, 0xFF455E45, 0xFF4747B8, 0xFF534C52, 0xFFB8A042, 0xFF525252, 0xFFFF7042, 0xFFB84C00, 0xFF4F4600, 0xFF8C704C, 0xFFFF8CFF, 0xFFFF00FF, 0xFFFF00FF, 0xFFFF00FF, 0xFFFF7070, 0xFFFF8C4B, 0xFFA0A0FF, 0xFFA0FFA0, 0xFFFF8080, 0xFF80FFFF, 0xFFFF7070, 0xFFFF8C4B, 0xFFA0A0FF, 0xFFA0FFA0, 0xFFFF8080, 0xFF80FFFF, 0xFFFF7070, 0xFFFF8C4B, 0xFFA0A0FF, 0xFFA0FFA0, 0xFFFF8080, 0xFF80FFFF]);
{
{
}}});
;//5.0.1-v7 Fri May 30 04:05:41 CDT 2025
...
Clazz_makeConstructor(c$, 
function(monomers){
Clazz_superConstructor(this, JM.CarbohydratePolymer, [monomers, false]);
this.type = 3;
}, "~A");
});
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
...
/*LV!1824 unnec constructor*/c$.add = Clazz_defineMethod(c$, "add", 
function(info, g1, g2){
...
Clazz_instantialize(this, arguments);}, J.dssx, "Bridge", null);
Clazz_makeConstructor(c$, 
...
Clazz_instantialize(this, arguments);}, J.dssx, "DSSP", null);
Clazz_prepareFields (c$, function(){
...
Clazz_instantialize(this, arguments);}, J.g3d, "HermiteRenderer", null, J.g3d.G3DRenderer);
Clazz_prepareFields (c$, function(){
this.pLeft =  new Array(16);
this.pRight =  new Array(16);
this.sLeft =  Clazz_newFloatArray (16, 0);
this.sRight =  Clazz_newFloatArray (16, 0);
...
this.needToFill =  Clazz_newBooleanArray(16, false);
});
Clazz_makeConstructor(c$, 
function(){
});
...
Clazz_defineMethod(c$, "renderHermiteRope", 
function(fill, tension, diameterBeg, diameterMid, diameterEnd, p0, p1, p2, p3){
var z1 = Clazz_floatToInt(p1.z);
var z2 = Clazz_floatToInt(p2.z);
if (p0.z == 1 || z1 == 1 || z2 == 1 || p3.z == 1) return;
if (this.gdata.isClippedZ(z1) || this.gdata.isClippedZ(z2)) return;
var x1 = Clazz_floatToInt(p1.x);
var y1 = Clazz_floatToInt(p1.y);
var x2 = Clazz_floatToInt(p2.x);
var y2 = Clazz_floatToInt(p2.y);
var xT1 = Clazz_doubleToInt(((x2 - Clazz_floatToInt(p0.x)) * tension) / 8);
var yT1 = Clazz_doubleToInt(((y2 - Clazz_floatToInt(p0.y)) * tension) / 8);
var zT1 = Clazz_doubleToInt(((z2 - Clazz_floatToInt(p0.z)) * tension) / 8);
var xT2 = Clazz_doubleToInt(((Clazz_floatToInt(p3.x) - x1) * tension) / 8);
var yT2 = Clazz_doubleToInt(((Clazz_floatToInt(p3.y) - y1) * tension) / 8);
var zT2 = Clazz_doubleToInt(((Clazz_floatToInt(p3.z) - z1) * tension) / 8);
this.sLeft[0] = 0;
...
var s = this.sLeft[sp];
if (fill) {
var d = (s < 0.5 ? diameterBeg + Clazz_floatToInt(dDiameterFirstHalf * s) : diameterMid + Clazz_floatToInt(dDiameterSecondHalf * (s - 0.5)));
...
pMid.x = Clazz_doubleToInt(h1 * x1 + h2 * x2 + h3 * xT1 + h4 * xT2);
pMid.y = Clazz_doubleToInt(h1 * y1 + h2 * y2 + h3 * yT1 + h4 * yT2);
pMid.z = Clazz_doubleToInt(h1 * z1 + h2 * z2 + h3 * zT1 + h4 * zT2);
...
var x5 = Clazz_floatToInt(p5.x);
var y5 = Clazz_floatToInt(p5.y);
var z5 = Clazz_floatToInt(p5.z);
var x6 = Clazz_floatToInt(p6.x);
var y6 = Clazz_floatToInt(p6.y);
var z6 = Clazz_floatToInt(p6.z);
var xT5 = Clazz_doubleToInt(((x6 - Clazz_floatToInt(p4.x)) * tension) / 8);
var yT5 = Clazz_doubleToInt(((y6 - Clazz_floatToInt(p4.y)) * tension) / 8);
var zT5 = Clazz_doubleToInt(((z6 - Clazz_floatToInt(p4.z)) * tension) / 8);
var xT6 = Clazz_doubleToInt(((Clazz_floatToInt(p7.x) - x5) * tension) / 8);
var yT6 = Clazz_doubleToInt(((Clazz_floatToInt(p7.y) - y5) * tension) / 8);
var zT6 = Clazz_doubleToInt(((Clazz_floatToInt(p7.z) - z5) * tension) / 8);
...
c$.isFront = Clazz_defineMethod(c$, "isFront", 
function(a, b, c){
...
Clazz_defineMethod(c$, "renderParallelPair", 
function(fill, tension, p0, p1, p2, p3, p4, p5, p6, p7){
var endPoints =  Clazz_newArray(-1, [p2, p1, p6, p5]);
...
if (strands == 1) {
x1 = Clazz_floatToInt(p5.x);
y1 = Clazz_floatToInt(p5.y);
z1 = Clazz_floatToInt(p5.z);
x2 = Clazz_floatToInt(p6.x);
y2 = Clazz_floatToInt(p6.y);
z2 = Clazz_floatToInt(p6.z);
xT1 = Clazz_doubleToInt(((x2 - Clazz_floatToInt(p4.x)) * tension) / 8);
yT1 = Clazz_doubleToInt(((y2 - Clazz_floatToInt(p4.y)) * tension) / 8);
zT1 = Clazz_doubleToInt(((z2 - Clazz_floatToInt(p4.z)) * tension) / 8);
xT2 = Clazz_doubleToInt(((Clazz_floatToInt(p7.x) - x1) * tension) / 8);
yT2 = Clazz_doubleToInt(((Clazz_floatToInt(p7.y) - y1) * tension) / 8);
zT2 = Clazz_doubleToInt(((Clazz_floatToInt(p7.z) - z1) * tension) / 8);
this.sLeft[0] = 0;
this.pLeft[0].set(x1, y1, z1);
this.sRight[0] = 1;
this.pRight[0].set(x2, y2, z2);
...
this.range = 0;
this.floatRange = 0;
Clazz_instantialize(this, arguments);}, J.shapebio, "BioShape", J.shape.AtomShape);
Clazz_makeConstructor(c$, 
...
this.isActive = false;
this.bioShapes = null;
Clazz_instantialize(this, arguments);}, J.shapebio, "BioShapeCollection", J.shape.Shape);
...
Clazz_instantialize(this, arguments);}, J.shapebio, "Backbone", J.shapebio.BioShapeCollection);
Clazz_overrideMethod(c$, "initShape", 
function(){
this.madOn = 1;
...
Clazz_instantialize(this, arguments);}, J.renderbio, "BioShapeRenderer", J.render.ShapeRenderer);
Clazz_prepareFields (c$, function(){
...
TF = (this.isExport || !this.wireframeOnly && this.vwr.getBoolean(603979863));
...
}this.renderStruts = (this.vwr.shm.getShape(1)).haveStrutPoints;
});
...
if (!this.meshRenderer.setFancyConic(i, tension)) return;
} else {
...
Clazz_defineMethod(c$, "checkStruts", 
function(i){
...
Clazz_defineMethod(c$, "getStrutPointIfNeeded", 
function(a){
var p = a.group.strutPoint;
return (p != null && p.sX == -2147483648 ? p : null);
}, "JM.Atom");
Clazz_defineMethod(c$, "setStrutPoint", 
function(a, newPt){
var p = this.getStrutPointIfNeeded(a);
if (p == null) return;
if (newPt == null) newPt = a;
p.setP(newPt);
p.sX = newPt.sX;
p.sY = newPt.sY;
p.sZ = newPt.sZ;
...
Clazz_instantialize(this, arguments);}, J.renderbio, "StrandsRenderer", J.renderbio.BioShapeRenderer);
...
this.scrBox = null;
this.triangles = null;
Clazz_instantialize(this, arguments);}, J.renderbio, "NucleicRenderer", null);
Clazz_prepareFields (c$, function(){
this.triangles =  Clazz_newIntArray(-1, [1, 0, 3, 1, 3, 2, 0, 4, 7, 0, 7, 3, 4, 5, 6, 4, 6, 7, 5, 1, 2, 5, 2, 6, 2, 3, 7, 2, 7, 6, 0, 1, 5, 0, 5, 4]);
});
Clazz_makeConstructor(c$, 
function(){
});
...
stepPt = this.rPt[pt];
}var mad = (thisMad > 1 ? Clazz_doubleToInt(thisMad / 2) : thisMad);
var r = mad / 2000;
var w = Clazz_floatToInt(this.vwr.tm.scaleToScreen(Clazz_floatToInt(this.backboneScreen.z), mad));
...
Clazz_defineMethod(c$, "renderSteps", 
function(g, i){
...
Clazz_defineMethod(c$, "renderBlock", 
function(g){
var atomA = g.getLeadAtom();
var cA = this.colix;
if (this.scrBox == null) {
...
this.rr = null;
Clazz_instantialize(this, arguments);}, J.renderbio, "RocketsRenderer", J.renderbio.StrandsRenderer);
Clazz_overrideMethod(c$, "renderBioShape", 
function(bioShape){
...
Clazz_defineMethod(c$, "adjustStrut", 
function(segments, start, end, offset){
for (var i = start; i <= end; i++) {
var a = this.monomers[i + offset].getLeadAtom();
var pt = this.getStrutPointIfNeeded(a);
if (pt != null) {
pt.setT(segments[i]);
pt.sX = 0;
}}
...
Clazz_instantialize(this, arguments);}, J.renderbio, "CartoonRenderer", J.renderbio.RocketsRenderer);
Clazz_overrideMethod(c$, "renderBioShape", 
function(bioShape){
...
Clazz_instantialize(this, arguments);}, J.renderbio, "BackboneRenderer", J.renderbio.BioShapeRenderer);
Clazz_overrideMethod(c$, "renderBioShape", 
function(bioShape){
...
this.drawSegmentAB(atomA, atomB, cA, cB, 100);
if (this.renderStruts) {
this.setStrutPoint(atomA, null);
this.setStrutPoint(atomB, null);
}}}}
}, "J.shapebio.BioShape");
});
;//5.0.1-v7 Tue May 20 13:40:34 CDT 2025
