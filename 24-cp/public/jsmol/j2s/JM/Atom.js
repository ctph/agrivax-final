...
Clazz.load(["JU.Node", "$.Point3fi", "J.c.PAL"], "JM.Atom", ["JU.BS", "$.CU", "$.P3", "$.PT", "$.SB", "J.atomdata.RadiusData", "J.c.VDW", "JM.Group", "JU.C", "$.Elements", "JV.JC"], function(){
...
Clazz.instantialize(this, arguments);}, JM, "Atom", JU.Point3fi, JU.Node);
Clazz.prepareFields (c$, function(){
this.paletteID = J.c.PAL.CPK.id;
});
Clazz.overrideMethod(c$, "setAtom", 
function(modelIndex, atomIndex, xyz, radius, atomSymmetry, atomSite, atomicAndIsotopeNumber, formalCharge, isHetero, isNegDisorder){
this.mi = modelIndex;
...
Clazz.defineMethod(c$, "setNegativeDisorder", 
function(){
this.formalChargeAndFlags |= 4;
});
Clazz.defineMethod(c$, "isNegativeDisorder", 
function(){
...
Clazz.defineMethod(c$, "getCovalentOrPartialBondCount", 
function(){
if (this.bonds == null) return 0;
var n = 0;
for (var i = this.bonds.length; --i >= 0; ) {
...
case 1111490588:
return JU.C.getColixTranslucencyFractional(this.colixAtom);
case 1312817669:
