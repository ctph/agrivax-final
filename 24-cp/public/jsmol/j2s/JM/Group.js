...
/*LV!1824 unnec constructor*/Clazz.defineMethod(c$, "setGroup", 
...
Clazz.defineMethod(c$, "unsetStrutPoint", 
function(){
if (this.strutPoint == null) this.strutPoint =  new JU.Point3fi();
this.strutPoint.sX = -2147483648;
});
