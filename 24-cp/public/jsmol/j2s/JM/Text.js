...
Clazz.load(null, "JM.Text", ["JU.PT", "J.shape.Shape", "JU.C", "$.Font", "JV.JC"], function(){
...
this.barPixelsXYZ = 0;
this.sppa = 0;
Clazz.instantialize(this, arguments);}, JM, "Text", null);
...
boxXY[1] = this.movableY - this.yAdj + Clazz.doubleToInt((this.descent - this.ascent) / 2) + 8;
isAbsolute = true;
this.boxYoff2 = -2;
} else {
this.boxYoff2 = 0;
...
Clazz.defineMethod(c$, "isPymolOffsetRelative", 
function(){
var mode = (this.pymolOffset == null ? -1 : Clazz.floatToInt(this.pymolOffset[0]));
return ((mode & 1) == 1);
});
Clazz.defineMethod(c$, "isPymolOffsetPixels", 
function(){
var mode = (this.pymolOffset == null ? -1 : Clazz.floatToInt(this.pymolOffset[0]));
return (mode != -1 && ((mode & 2) == 2));
});
Clazz.defineMethod(c$, "getStateText", 
function(){
