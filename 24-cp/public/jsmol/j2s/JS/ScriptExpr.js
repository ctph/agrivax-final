...
this.ptTemp = null;
Clazz.instantialize(this, arguments);}, JS, "ScriptExpr", JS.ScriptParam);
...
rpn.addXObj(val);
break;
}if ((typeof(val)=='string') || Clazz.instanceOf(val,"JU.Lst")) val = this.getStringObjectAsVariable(val);
...
return null;
}var needVariable = (!settingData && t == null && (isThrown || !((typeof(tv.value)=='string') || tv.tok == 2 || Clazz.instanceOf(tv.value, Integer) || Clazz.instanceOf(tv.value, Float) || Clazz.instanceOf(tv.value, Boolean))));
