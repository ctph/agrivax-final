...
Clazz.defineMethod(c$, "newSearch", 
function(s){
return (s == null ? null : Clazz.instanceOf(s,"JS.SmilesSearch") ? s : JS.SmilesParser.newSearch(JS.SmilesParser.cleanPattern(s.toString()), false, true));
}, "~O");
