...
}return (m4 == null ? mp.addXStr("") : asRXYZ || asABC || asUVW || asXYZ ? mp.addXStr(this.matToString(m4, asRXYZ ? 0x1 : asABC ? 0xABC : asUVW ? 0xDEF : 0)) : mp.addXM4(m4));
}, "JS.ScriptMathProcessor,~A");
Clazz.defineMethod(c$, "matToString", 
function(m4, mode){
...
Clazz.defineMethod(c$, "getSubgroupInfo", 
function(args, nargs){
var sym;
...
Clazz.defineMethod(c$, "listSpecial", 
...
Clazz.defineMethod(c$, "getRealPointFromFraction", 
function(s){
...
mp.addX(x);
return this.evaluateInChI(mp,  Clazz.newArray(-1, [JS.SV.newS("SMILES " + (args.length > 0 ? args[0].asString() : sx.indexOf("/f") >= 0 ? "fixedh" : "amide"))]));
}}
...
o = this.getSymopInfo(mp, null,  Clazz.newArray(-1, [list.get(i), args[1]]), i + 1, false);
...
case 1073742328:
bsSelected = (len == 3 && Clazz.instanceOf(args[1].value,"JU.BS") && Clazz.instanceOf(args[2].value,"JU.BS") ? this.vwr.getBranchBitSet((args[2].value).nextSetBit(0), (args[1].value).nextSetBit(0), true) : null);
break out;
case 134218757:
case 1237320707:
case 134218756:
...
;//5.0.1-v7 Fri May 30 04:48:50 CDT 2025
